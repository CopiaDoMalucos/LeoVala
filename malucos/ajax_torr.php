...
$thisurl = "ajax_torr.php?";
if ($_POST["cat"]) {
	$wherea[] = "category = " . sqlesc($_POST["cat"]);
	$addparam .= "cat=" . urlencode($_POST["cat"]) . "&amp;";
	$thisurl .= "cat=".urlencode($_POST["cat"])."&amp;";
}

if ($_POST["parent_cat"]) {
	$addparam .= "parent_cat=" . urlencode($_POST["parent_cat"]) . "&amp;";
	$thisurl .= "parent_cat=".urlencode($_POST["parent_cat"])."&amp;";
	$wherea[] = "categories.parent_cat=".sqlesc($_POST["parent_cat"]);
}
...
if ($_POST['sort'] && $_POST['order']) {
	...
	$pagerlink = "sort=" . $_POST['sort'] . "&amp;order=" . $_POST['order'] . "&amp;";

if (is_valid_id($_POST["page"]))
	$thisurl .= "page=$_POST[page]&amp;";
