...
if ($test != "")
  print("<p><b>TEST PREVIEW:</b><hr />" . format_comment($test1) . "<hr /></p>\n");
...
insert_tag(
	"Image (alt. 2)",
	"Inserts a picture.",
	"[screem]<i>URL</i>[/screem]",
	"[screem]".$site_config["SITEURL"]."/images/banner.jpg[/screem]",
...
insert_tag(
	...
	"Inserts a flash.",
	"[flash]<i>URL</i>[/flash]",
	"[flash 100,100]http://upamais.com/images/60725512371836558582.swf[/flash]",
	"The URL must end with <b>.swf</b>"
);
insert_tag(
	"Image (alt. 1)",
	"Inserts a picture.",
