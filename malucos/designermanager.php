...
if (!$exepedi["id"]){
show_error_msg("Erro", "Kit selecionada não encontrado!!!!<br>[<a href='designermanager.php'>Voltar</a>]", 1);
}
...
<table cellspacing="1" cellpadding="0" width="100%" align="center" id="tabela1">
	...
	<td width="20%" align="center" class="tab1_col3">
	<a href="designermanager.php?action=aceito&do=1"><img border="0" alt="" src="/images/Icon_perfil.png"><br>Pedido Atendido</a>
	<td width="20%" align="center" class="tab1_col3">
