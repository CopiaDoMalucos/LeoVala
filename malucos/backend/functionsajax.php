...
function loggedinonly() {
	global $CURUSER;
	if (!$CURUSER) {
		header('location:http://www.malucos-share.org/account-login.php?returnto=%2Findex.php'); die();
