...
function torrenttable($res) {
	...
	//tri
       ...
       $scriptname= 'grupos_lancamentos.php';
...
echo '<ul style="margin:0;padding:0;" class="alista">';
	...
	foreach ($cols as $col) {
		switch ($col) {
			             case 'category':
                               echo "<div style='width: 50px;' class='divhead'><div style='width: 50px;'><a href=\"$scriptname?$addparam"."id=".$idteam1."&cat=".$idteam."&parent_cat=".$parent_catid."&sort=category&order=".($sort=="category" && $order=="desc"?"asc":"desc")."\"><font color='white'>Tipo</font></a>".($sort=="category"?$fleche:"")."</div></div>";
                        break;
                        case 'name':
                                echo "<div style='text-align: left; min-width: 200px; width: 732px;' class='divhead'><a href=\"$scriptname?$addparam"."id=".$idteam1."&cat=".$idteam."&parent_cat=".$parent_catid."&sort=name&order=".($sort=="name" && $order=="desc"?"asc":"desc")."\"><font color='white'>Nome</font></a>".($sort=="name"?$fleche:"")."</div>";
                        break;
                        case 'dl':
                                echo "<div style='width: 60px;' class='divhead'><div style='width: 60px;'>Down</div></div>";
                        break;
                        case 'comments':
                                echo "<div style='width: 60px;' class='divhead'><div style='width: 60px; font-size: 10px;'><a href=\"$scriptname?$addparam"."id=".$idteam1."&cat=".$idteam."&parent_cat=".$parent_catid."&sort=comments&order=".($sort=="comments" && $order=="desc"?"asc":"desc")."\"><font color='white'>Com</font></a>".($sort=="comments"?$fleche:"")."</div></div>";
                        break;
                        case 'size':
                                echo "<div style='width: 60px;' class='divhead'><div style='width: 60px; font-size: 10px;'><a href=\"$scriptname?$addparam"."id=".$idteam1."&cat=".$idteam."&parent_cat=".$parent_catid."&sort=size&order=".($sort=="size" && $order=="desc"?"asc":"desc")."\"><font color='white'>Tamanho</font></a>".($sort=="size"?$fleche:"")."</div></div>";
                        break;
                        case 'seeders':
                                echo "<div style='width: 60px;' class='divhead'><div style='width: 60px; font-size: 10px;'><a href=\"$scriptname?$addparam"."id=".$idteam1."&cat=".$idteam."&parent_cat=".$parent_catid."&sort=seeders&order=".($sort=="seeders" && $order=="desc"?"asc":"desc")."\"><font color='white'>S</font></a>".($sort=="seeders"?$fleche:"")."</div></div>";
                        break;
                        case 'leechers':
                                echo "<div style='width: 60px;' class='divhead'><div style='width: 60px; font-size: 10px;'><a href=\"$scriptname?$addparam"."id=".$idteam1."&cat=".$idteam."&parent_cat=".$parent_catid."&sort=leechers&order=".($sort=="leechers" && $order=="desc"?"asc":"desc")."\"><font color='white'>L</font></a>".($sort=="leechers"?$fleche:"")."</div></div>";
                        break;
		...
		switch ($col) {
			case 'category':
				...
				if (!empty($row["cat_name"])) {
					print("<a href=\"grupos_lancamentos.php?id=".$idteam1."&cat=" . $row["category"] . "&parent_cat=".$parent_catid."&sort=0&order=".($sort=="size" && $order=="desc"?"asc":"desc")."\">");
            ...
            ///filmes		 
	           elseif ($row["category"] == 2 || $row["category"] == 3 || $row["category"] == 4 || $row["category"] == 5 || $row["category"] == 6 || $row["category"] == 7 || $row["category"] == 23 || $row["category"] == 24 || $row["category"] == 25 || $row["category"] == 26 || $row["category"] == 27 || $row["category"] == 33 || $row["category"] == 34 || $row["category"] == 35 || $row["category"] == 36 || $row["category"] == 37 || $row["category"] == 39 || $row["category"] == 40 || $row["category"] == 41 || $row["category"] == 42 || $row["category"] == 49 || $row["category"] == 95 || $row["category"] == 96 || $row["category"] == 97 || $row["category"] == 98 || $row["category"] == 99 || $row["category"] == 100 || $row["category"] == 101 || $row["category"] == 103 || $row["category"] == 110 || $row["category"] == 118 || $row["category"] == 114 || $row["category"] == 117 || $row["category"] == 120 || $row["category"] == 124 || $row["category"] == 112) 
			     ...
			     print("<div style='text-align: left; min-width: 200px; width: 732px;' class='divlista'>".(count($expandrows)?"":"")."   <a style=\"\" title=\"<table width=100%  cellspacing=0 cellpadding=5 align=center><tr valign=top><td align=center><img border=0 width=150 height=150 src=$balon></td><td><div align=left>Audio: &lt;B&gt;" .$row["filmeaudio_name"] . "&lt;/B&gt;&lt;br&gt;Qualidade: &lt;B&gt;" .$row["filmequalidade_name"] . "&lt;/B&gt;&lt;br&gt;Extensão: &lt;B&gt;" .$row["filmeextensao_name"] . "&lt;/B&gt;&lt;br&gt;Ano: &lt;B&gt;" .$row["filmeano_name"] . "&lt;/B&gt;&lt;br&gt;Resolução: &lt;B&gt;" . $row["filmeresolucao"] . "X" . $row["filmeresolucalt"] . "&lt;/B&gt;&lt;br&gt;&lt;hr&gt;Lançado por &lt;B&gt;" . $row["username"] . "&lt;/B&gt;&lt;br&gt;Lançado em &lt;B&gt;" . date("d/m/y", utc_to_tz_time($row['added']))." às ". date("H:i:s", utc_to_tz_time($row['added'])) . "&lt;/B&gt;\" href=\"torrents-details.php?id=$id\">$dispname</a></div>");
	              ...
	              {			  
                        print("<div style='text-align: left; min-width: 200px; width: 732px;' class='divlista'>".(count($expandrows)?"":"")."   <a style=\"\" title=\"<table width=100%  cellspacing=0 cellpadding=5 align=center><tr valign=top><td align=center><img border=0 width=150 height=150 src=$balon></td><td><div align=left>Extensão: &lt;B&gt;" .$row["apliformarq_name"] . "&lt;/B&gt;&lt;br&gt;Ano: &lt;B&gt;" .$row["filmeano_name"] . "&lt;/B&gt;&lt;br&gt;Crack: &lt;B&gt;" .$row["aplicrack_name"] . "&lt;/B&gt;&lt;br&gt;&lt;hr&gt;Lançado por &lt;B&gt;" . $row["username"] . "&lt;/B&gt;&lt;br&gt;Lançado em &lt;B&gt;" . date("d/m/y", utc_to_tz_time($row['added']))." às ". date("H:i:s", utc_to_tz_time($row['added'])) . "&lt;/B&gt;\" href=\"torrents-details.php?id=$id\">$dispname</a></div>");
                        }	
							 			///músicas
	              ...
	              {			  
                  print("<div style='text-align: left; min-width: 200px; width: 732px;' class='divlista'>".(count($expandrows)?"":"")."   <a style=\"\" title=\"<table width=100%  cellspacing=0 cellpadding=5 align=center><tr valign=top><td align=center><img border=0 width=150 height=150 src=$balon></td><td><div align=left>Extensão: &lt;B&gt;" .$row["musicatensao_name"] . "&lt;/B&gt;&lt;br&gt;Qualidade: &lt;B&gt;" .$row["musicaqualidade_name"] . "&lt;/B&gt;&lt;br&gt;Ano: &lt;B&gt;" .$row["filmeano_name"] . "&lt;/B&gt;&lt;br&gt;&lt;hr&gt;Lançado por &lt;B&gt;" . $row["username"] . "&lt;/B&gt;&lt;br&gt;Lançado em &lt;B&gt;" . date("d/m/y", utc_to_tz_time($row['added']))." às ". date("H:i:s", utc_to_tz_time($row['added'])) . "&lt;/B&gt;\" href=\"torrents-details.php?id=$id\">$dispname</a></div>");
                   	   }		
