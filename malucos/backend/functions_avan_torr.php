...
function genrelist() {
    $ret = array();
    $res = SQL_Query_exec("SELECT id, name, parent_cat FROM categories  WHERE parent_cat='Filmes'OR parent_cat='Anime' ORDER BY name ASC");
...
$s = preg_replace("/\[mail\]((\s|.)+?)\[\/mail\]/i","<a href=\"mailto:\\1\" target=\"_blank\">\\1</a>", $s);
  ...
  {
    $s = preg_replace("/\[screem\](http:\/\/[^\s'\"<>]+(\.(jpg|gif|png)))\[\/screem\]/i", "<a href='\\1' rel='colorbox-{$pn}'><img style='max-width:400px;' src=\"\\1\" </a><br><small>[ Ver em tamanho real ]</small></a>", $s);
 ...
 $searcht = $_REQUEST['search'];
  ...
  $freeleecht = $_REQUEST['freeleech'];
	...
	foreach ($cols as $col) {
		switch ($col) {
			             case 'category':
                               echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&search=".$searcht."&termos=".$termos."&search_in=".$search_in."&incldead=".$incldead."&freeleech=".$freeleecht."&sort=category&order=".($sort=="category" && $order=="desc"?"asc":"desc")."\"><font color='white'>".T_("TYPE")."</font></a>".($sort=="category"?$fleche:"")."</td>";
                        break;
                        case 'name':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&search=".$searcht."&termos=".$termos."&search_in=".$search_in."&incldead=".$incldead."&freeleech=".$freeleecht."&sort=name&order=".($sort=="name" && $order=="desc"?"asc":"desc")."\"><font color='white'>".T_("NAME")."</font></a>".($sort=="name"?$fleche:"")."</td>";
                        break;
                        case 'dl':
                        ...
                        break;
                        case 'comments':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&search=".$searcht."&termos=".$termos."&search_in=".$search_in."&incldead=".$incldead."&freeleech=".$freeleecht."&sort=comments&order=".($sort=="comments" && $order=="desc"?"asc":"desc")."\"><font color='white'>Com</font></a>".($sort=="comments"?$fleche:"")."</td>";
                        break;
                        case 'nfo':
                                echo "<td class=ttable_head>NFO</td>";
                        break;
                        case 'size':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&search=".$searcht."&termos=".$termos."&search_in=".$search_in."&incldead=".$incldead."&freeleech=".$freeleecht."&sort=size&order=".($sort=="size" && $order=="desc"?"asc":"desc")."\"><font color='white'> ".T_("SIZE")."</font></a>".($sort=="size"?$fleche:"")."</td>";
                        break;
                        case 'completed':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&search=".$searcht."&termos=".$termos."&search_in=".$search_in."&incldead=".$incldead."&freeleech=".$freeleecht."&sort=completed&order=".($sort=="completed" && $order=="desc"?"asc":"desc")."\"><font color='white'>C</font></a>".($sort=="completed"?$fleche:"")."</td>";
                        break;
                        case 'seeders':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&search=".$searcht."&termos=".$termos."&search_in=".$search_in."&incldead=".$incldead."&freeleech=".$freeleecht."&sort=seeders&order=".($sort=="seeders" && $order=="desc"?"asc":"desc")."\"><font color='white'>S</font></a>".($sort=="seeders"?$fleche:"")."</td>";
                        break;
                        case 'leechers':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&search=".$searcht."&termos=".$termos."&search_in=".$search_in."&incldead=".$incldead."&freeleech=".$freeleecht."&sort=leechers&order=".($sort=="leechers" && $order=="desc"?"asc":"desc")."\"><font color='white'>L</font></a>".($sort=="leechers"?$fleche:"")."</td>";
                        break;
		...
		switch ($col) {
			case 'category':
				...
				if (!empty($row["cat_name"])) {
					print("<a href=\"torrents-pesquisa.php?cat=" . $row["category"] . "&parent_cat=".$parent_catid."&search=".$searcht."&termos=".$termos."&search_in=".$search_in."&incldead=".$incldead."&freeleech=".$freeleecht."&sort=size&order=".($sort=="size" && $order=="desc"?"asc":"desc")."\">");
...
$grupos_exe="";
    ...
    $text = format_comment($row["text"]);
        ...
        print('<tr class="p-title-coment">');
        print('<td align="center" width="17%">'.$postername.'</td>');
