...
require_once(BACKEND."/configdesativar.php");  //Get Site Settings and Vars ($site_config)
require(BACKEND."/tzs.php"); // Get Timezones
require_once(BACKEND."/cache.php"); // Caching
require_once(BACKEND."/maildesativ.php"); // Mail functions
...
//fin tri
	...
	foreach ($cols as $col) {
		switch ($col) {
			             case 'category':
                               echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&sort=category&order=".($sort=="category" && $order=="desc"?"asc":"desc")."\"><font color='white'>".T_("TYPE")."</font></a>".($sort=="category"?$fleche:"")."</td>";
                        break;
                        case 'name':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&sort=name&order=".($sort=="name" && $order=="desc"?"asc":"desc")."\"><font color='white'>".T_("NAME")."</font></a>".($sort=="name"?$fleche:"")."</td>";
                        break;
                        case 'dl':
                        ...
                        break;
                        case 'comments':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&sort=comments&order=".($sort=="comments" && $order=="desc"?"asc":"desc")."\"><font color='white'>Com</font></a>".($sort=="comments"?$fleche:"")."</td>";
                        break;
                        case 'nfo':
                                echo "<td class=ttable_head>NFO</td>";
                        break;
                        case 'size':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&sort=size&order=".($sort=="size" && $order=="desc"?"asc":"desc")."\"><font color='white'> ".T_("SIZE")."</font></a>".($sort=="size"?$fleche:"")."</td>";
                        break;
                        case 'completed':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&sort=completed&order=".($sort=="completed" && $order=="desc"?"asc":"desc")."\"><font color='white'>C</font></a>".($sort=="completed"?$fleche:"")."</td>";
                        break;
                        case 'seeders':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&sort=seeders&order=".($sort=="seeders" && $order=="desc"?"asc":"desc")."\"><font color='white'>S</font></a>".($sort=="seeders"?$fleche:"")."</td>";
                        break;
                        case 'leechers':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_catid."&sort=leechers&order=".($sort=="leechers" && $order=="desc"?"asc":"desc")."\"><font color='white'>L</font></a>".($sort=="leechers"?$fleche:"")."</td>";
                        break;
					
							case 'bookmark':
                         if ($variant == "bookmarks")
                             echo "<td class=ttable_head>Delete</td>";
                                else
                             echo "<td class=ttable_head>F</td>";
                        break;
							case 'wait':
				         if ($wait)
