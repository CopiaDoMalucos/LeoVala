...
foreach ($cols as $col) {
		switch ($col) {
			case 'category':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."id=".$idteam."&cat=".$catlan."&sort=category&order=".($sort=="category" && $order=="desc"?"asc":"desc")."\"><font color='white'>".T_("TYPE")."</font></a>".($sort=="category"?$fleche:"")."</td>";
                        break;
                        case 'name':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."id=".$idteam."&cat=".$catlan."&sort=name&order=".($sort=="name" && $order=="desc"?"asc":"desc")."\"><font color='white'>".T_("NAME")."</font></a>".($sort=="name"?$fleche:"")."</td>";
                        break;
                        ...
                        break;
                        case 'comments':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."id=".$idteam."&cat=".$catlan."&sort=comments&order=".($sort=="comments" && $order=="desc"?"asc":"desc")."\"><font color='white'>Comm</font></a>".($sort=="comments"?$fleche:"")."</td>";
                        break;
                        case 'nfo':
                                echo "<td class=ttable_head>NFO</td>";
                        break;
                        case 'size':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."id=".$idteam."&cat=".$catlan."&sort=size&order=".($sort=="size" && $order=="desc"?"asc":"desc")."\"><font color='white'> ".T_("SIZE")."</font></a>".($sort=="size"?$fleche:"")."</td>";
                        break;
                        case 'completed':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."id=".$idteam."&cat=".$catlan."&sort=completed&order=".($sort=="completed" && $order=="desc"?"asc":"desc")."\"><font color='white'>C</font></a>".($sort=="completed"?$fleche:"")."</td>";
                        break;
                        case 'seeders':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."id=".$idteam."&cat=".$catlan."&sort=seeders&order=".($sort=="seeders" && $order=="desc"?"asc":"desc")."\"><font color='white'>S</font></a>".($sort=="seeders"?$fleche:"")."</td>";
                        break;
                        case 'leechers':
                                echo "<td class=ttable_head><a href=\"$scriptname?$addparam"."id=".$idteam."&cat=".$catlan."&sort=leechers&order=".($sort=="leechers" && $order=="desc"?"asc":"desc")."\"><font color='white'>L</font></a>".($sort=="leechers"?$fleche:"")."</td>";
			            break;
		...
		switch ($col) {
			case 'category':
				...
				if (!empty($row["cat_name"])) {
					print("<a href=\"lancados.php?id=".$idteam."&cat=" . $row["category"] . "\">");
