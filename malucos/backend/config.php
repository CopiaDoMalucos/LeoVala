...
// Main Site Settings
$site_config['SITENAME'] = '..::Malucos Share::.. Sempre fazendo o melhor por você!!!';					//Site Name
$site_config['SITEEMAIL'] = 'contato@malucos-share.org';		//Emails will be sent from this address
$site_config['SITEURL'] = 'http://www.malucos-share.org';	//Main Site URL
$site_config['default_language'] = "1"; 						//DEFAULT LANGUAGE ID
$site_config['default_theme'] = "3";						//DEFAULT THEME ID
$site_config['CHARSET'] = "utf-8";						//Site Charset
$site_config['announce_list'] = "http://www.malucos-share.org/announce.php"; //seperate via comma
...
$site_config['maxusers'] = 9000000; // Max # of enabled accounts
$site_config['maxusers_invites'] = $site_config['maxusers'] + 5000000; // Max # of enabled accounts when inviting
...
$site_config['OFFLINEMSG'] = 'O site malucos-share.org está em manutenção. Por favor, aguarde. dentro de alguns minutos já voltaremos continue semeando ^^';	

$site_config['WELCOMEPMON'] = true;			//Auto PM New members
$site_config['WELCOMEPMMSG'] = 'Seja Bem Vindo a família Malucos-Share!!!

 Antes de navegar pelo site, leia as [url=http://www.malucos-share.org/rules.php]Regras[/url] e a nossa [url=http://www.malucos-share.org/faq.php]Ajuda[/url], Lembre-se de manter o seu ratio igual ou superior a 1.0, para que sua conta não seja cancelada, Caso tenha alguma dúvida ou queira mais informações não deixe de falar com nossa [url=http://www.malucos-share.org/staff.php]Equipe[/url] .

 visite também nossa comunidade no Facebook acesse >>> [url=http://www.facebook.com/groups/Malucos.Share/]Aqui[/url]
 
Atenciosamente,

Equipe MS';
$site_config['SITENOTICEON'] = false;
$site_config['SITENOTICE'] = '<br /><br />br /><br />';

$site_config['UPLOADRULES'] = 'Os torrents devem estar de acordo com as regras de lançamentos.
Torrents repetidos serão deletados sem aviso prévio.
Os torrents lançados deverão ser semeados por um período mínimo de 7 dias.
O método de envios de torrents é totalmente sistematizado. Qualquer dúvida, entre em contato com um dos nossos moderadores nos fóruns ou no ShoutBox.';
...
$site_config["REQUESTSON"] = true;
$site_config["KITPEDIDO"] = true;
$site_config["STAFFSHOUTBOX"] = true;
$site_config["ADVANCED_DONATER"] = true;
$site_config["cache_peers"] = true; // Cache peer lists
$site_config["cache_peers_time"] = 600; // Peer list cache time in seconds (Default: 10mins)

//WAIT TIME VARS
$site_config['WAIT_CLASS'] = '0';		//Classes wait time applies to, comma seperated
...
$site_config['GIGSB'] = '1';			//Minimum gigs
$site_config['RATIOB'] = '0.10';		//Minimum ratio
$site_config['WAITB'] = '12';			//If neither are met, wait time in hours

$site_config['GIGSC'] = '5';			//Minimum gigs
$site_config['RATIOC'] = '0.10';		//Minimum ratio
$site_config['WAITC'] = '6';			//If neither are met, wait time in hours

$site_config['GIGSD'] = '1';			//Minimum gigs
$site_config['RATIOD'] = '0.10';		//Minimum ratio
$site_config['WAITD'] = '2';			//If neither are met, wait time in hours

//CLEANUP AND ANNOUNCE SETTINGS
$site_config['PEERLIMIT'] = '100000000000000000000';			//LIMIT NUMBER OF PEERS GIVEN IN EACH ANNOUNCE
$site_config['autoclean_interval'] = '3600';		//Time between each auto cleanup (Seconds)
$site_config['LOGCLEAN'] = 28 * 86400;			// How often to delete old entries. (Default: 28 days)
$site_config['announce_interval'] = '7200';		//Announce Interval (Seconds)
...
$site_config['loguser'] = '1800';			//Maximum site members
...
$site_config["ratiowarn_minratio"] = 0.80; //Min Ratio
$site_config["ratiowarn_mingigs"] = 4;  //Min GB Downloaded
$site_config["ratiowarn_daystowarn"] = 15; //Days to ban
...
$site_config["torrenttable_columns"] = "category,name,dl,comments,size,seeders,leechers,bookmark";
...
$site_config["mail_smtp_user"] = "contato@malucos-share.org"; // SMTP username
$site_config["mail_smtp_pass"] = "##malucos##share##123"; // SMTP password

////

// Password hashing - Once set, cannot be changed without all users needing to reset their passwords
$site_config["passhash_method"] = "md5"; // Hashing method (sha1, md5 or hmac). Must use what your previous version of TT did or all users will need to reset their passwords
// Only used for hmac.
