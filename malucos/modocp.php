...
if($CURUSER["class"]< "84"){
show_error_msg("STOP", "Desculpe esta página é para o Staff");
}
...
global $site_config;
	...
	begin_framec("Ferramentas Moderação");
?>
<table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr>
<td align="center"><a href="modocp.php?action=cheats"><img src="images/admin/blocked.gif" border=0 width=32 height=32><br>Ratio Master</a><BR></td>
<td align="center"><a href="modocp.php?action=peers"><img src="images/admin/list_peers.png" border=0 width=32 height=32><br>Lista de Peers</a><BR></td>
<td align="center"><a href="modocp.php?action=warned"><img src="images/admin/warnedaccounts.gif" border=0 width=32 height=32><br>Usuários Advertidos</a><BR></td>
<td align="center"><a href="modocp.php?action=whoswhere"><img src="images/admin/ipchecker.gif" border=0 width=32 height=32><br>Navegação Usuários</a><BR></td>
<td align="center"><a href="modocp.php?action=torrentmanage"><img src="images/admin/torrents.gif" border=0 width=32 height=32><br>Torrent Gestão </a><BR></td>
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
...
<tr>
    <td align="center"><a href="modocp.php?action=lastcomm"><img src="images/admin/comments.png" border="0" width="32" height="32" alt="" /><br />Últimos Comentários</a><br /></td>
    <td align="center"><a href="modocp.php?action=masspm"><img src="images/admin/mass_pm.png" border="0" width="32" height="32" alt="" /><br />Envio de MP em massa</a><br /></td>
    <td align="center"><a href="modocp.php?action=peers"><img src="images/admin/peer_list.png" border="0" width="32" height="32" alt="" /><br />Lista de Peers</a><br /></td>
    <td align="center"><a href="modocp.php?action=reports&amp;do=view"><img src="images/admin/report_system.png" border="0" width="32" height="32" alt="" /><br />Relatórios</a><br /></td>
	    <td align="center"><a href="modocp.php?action=usersearch"><img src="images/admin/user_search.png" border="0" width="32" height="32" alt="" /><br />Busca Avançada de Usuários</a><br /></td>
	</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
	    <td align="center"><a href="modocp.php?action=news&amp;do=view"><img src="images/admin/news.png" border="0" width="32" height="32" alt="" /><br />Novidades Index</a><br /></td>
        <td align="center"><a href="modocp.php?action=warned"><img src="images/admin/warned_user.png" border="0" width="32" height="32" alt="" /><br />Usuários Advertidos</a><br /></td>
        <td align="center"><a href="modocp.php?action=duplicateips"><img src="images/admin/privacy_level.png" border="0" width="32" height="32" alt="" /><br />IP's Duplicados<br /></a></td>
    <td align="center"><a href="modocp.php?action=censor"><img src="images/admin/word_censor.png" border="0" width="32" height="32" alt="" /><br />Palavras Sensuradas</a><br /></td>
    <td align="center"><a href="modocp.php?action=torrentmanage"><img src="images/admin/torrents.png" border="0" width="32" height="32" alt="" /><br /><?php echo T_("TORRENTS"); ?></a><br /></td>
...
<tr>
    <td align="center"><a href="modocp.php?action=users"><img src="images/admin/simple_user_search.png" border="0" width="32" height="32" alt="" /><br />Busca Simples de Usuários<br /></a></td>  
    <td align="center"><a href="modocp.php?action=privacylevel"><img src="images/admin/privacy_level.png" border="0" width="32" height="32" alt="" /><br />Privacy Level<br /></a></td>     
    <td align="center"><a href="modocp.php?action=pendinginvite"><img src="images/admin/pending_invited_user.png" border="0" width="32" height="32" alt="" /><br />Pending Invited Users<br /></a></td>    
    <td align="center"><a href="modocp.php?action=invited"><img src="images/admin/invited_user.png" border="0" width="32" height="32" alt="" /><br />Invited Users<br /></a></td>    
...
<tr>
 ...
 <td align="center"><a href="modocp.php?action=avatars"><img src="images/admin/avatar_log.png" border="0" width="32" height="32" alt="" /><br />Gestão de Avatares</a><br /></td>
	<td align="center"><a href=modocp.php?action=sitelog><img src="images/admin/site_log.png" border=0 width=32 height=32><br>log staff</a><BR></td>
	<td align="center"><a href=upload-bonus.php><img src="images/admin/upload-manager.png" border=0 width=32 height=32><br />Upload Manager(Não Mexer)</a><br /></td>
 </tr>
</table>
...
if ($action == "duplicateips")
{
        ...
        list($pagertop, $pagerbottom, $limit) = pager(25, $num, 'modocp.php?action=duplicateips&amp;');
        ...
        <tr>
                        ...
                        <td class="table_col1" align="center"><a href="modocp.php?action=usersearch&amp;ip=<?php echo $row['ip']; ?>"><?php echo number_format($row['count']); ?></a></td>
        </tr>
        <?php endwhile; ?>
        </table>                 
        <?php else: ?>
...
if ($action == "massmail")
{
        ...
        <br />
        <form id="massmail" name="massmail" method="post" action="modocp.php?action=massmail">
...
if ($action == "style") {
	if ($do == "add") {
		...
		stdfoot();
		  ...
		  header("Refresh: 1;url=modocp.php?action=style");
		...
		if ($a == count($add)) {
			header("Refresh: 3;url=modocp.php?action=style");
		...
		echo "<center><a href='modocp.php?action=style&amp;do=add'>".T_("THEME_ADD")."</a><!-- - <b>".T_("THEME_CLICK_A_THEME_TO_EDIT")."</b>--></center><br />";
		echo T_("THEME_CURRENT").":<form id='deltheme' method='post' action='modocp.php?action=style&amp;do=del'><table width='60%' class='table_table' align='center'>".
		...
		echo "<p>".T_("THEME_IN_THEMES_BUT_NOT_IN_DB")."</p><form id='addtheme' action='modocp.php?action=style&amp;do=add2' method='post'><table width='60%' class='table_table' align='center'>".
...
if ($action=="news" && $do=="view"){
	...
	begin_framec("News");
	echo "<center><a href='modocp.php?action=news&amp;do=add'><b>Add News Item</b></a></center><br />";
...
if ($action=="news" && $do=="add"){
	...
	print("<center><form method='post' action='modocp.php' name='news'>\n");
...
<form method=post name=edit action=modocp.php>
...
if ($action=="blocks" && $do=="view") {
    ...
    print("<table class=\"table_table\" cellspacing=\"1\" align=\"center\" width=\"100%\">".
            "<tr>".
                "<th class=\"table_head\">Enabled Blocks</th>".
            "</tr>".
        "</table><br />".
...
if ($action=="categories" && $do=="view"){
	...
	echo "<center><a href='modocp.php?action=categories&amp;do=add'><b>Add New Category</b></a></center><br />";
	...
	while ($row = mysql_fetch_array($sql)) {
		...
		if (isset($row["image"]) && $row["image"] != "")
			...
			print("-");	
		print("</td><td class='table_col1'><a href='modocp.php?action=categories&amp;do=edit&amp;id=$id'>[EDIT]</a> <a href='modocp.php?action=categories&amp;do=delete&amp;id=$id'>[DELETE]</a></td></tr>");
	}
	echo("</table></center>");
	end_framec();
	stdfoot();
...
if ($action=="categories" && $do=="add"){
	...
	print("<center><form method='post' action='modocp.php'>\n");
...
if ($action=="peers"){
	...
	if( mysql_num_rows($result) != 0 ) {
		...
		print'<tr>';
		print'<th class="ttable_head">User</th>';
		print'<th class="ttable_head">Torrent</th>';
		print'<th class="ttable_head">IP</th>';
		print'<th class="ttable_head">Port</th>';
		print'<th class="ttable_head">Upl.</th>';
		print'<th class="ttable_head">Downl.</th>';
		print'<th class="ttable_head">Peer-ID</th>';
		print'<th class="ttable_head">Conn.</th>';
		print'<th class="ttable_head">Seeding</th>';
		print'<th class="ttable_head">Started</th>';
		print'<th class="ttable_head">Last<br />Action</th>';
		print'</tr>';
...
if ($action=="lastcomm"){
    ...
    list($pagertop, $pagerbottom, $limit) = pager(10, $count, "modocp.php?action=lastcomm&amp;");
 ...
 if ($action == "torrentmanage") {
        ...
        if ($_POST["do"] == "delete") {
            if (!@count($_POST["torrentids"]))
                  show_error_msg("Error", "Nothing selected click <a href='modocp.php?action=torrentmanage'>here</a> to go back.", 1);
            foreach ($_POST["torrentids"] as $id) {
                deletetorrent(intval($id));
                write_log("Torrent ID $id was deleted by $CURUSER[username]");
            }
            show_error_msg("Torrents Deleted", "Go <a href='modocp.php?action=torrentmanage'>back</a>?", 1);
        }
        ...
        list($pagertop, $pagerbottom, $limit) = pager(25, $count, "modocp.php?action=torrentmanage&amp;");
...
if ($_GET['do'] == "del") {
		...
		header("Refresh: 2;url=modocp.php?action=sitelog");
		stdhead();
...
begin_framec("Log");
	...
	echo "<form action='modocp.php?action=sitelog&do=del' method='POST'>";
...
if ($action == "cheats") {
	...
	begin_framec("Possible Cheater Detection");?>
	<center><form action='modocp.php?action=cheats' method='post'>
...
if ($action=="polls" && $do=="view"){
	...
	echo "<center><a href='modocp.php?action=polls&amp;do=add'>Add New Poll</a>";
	echo "<a href='modocp.php?action=polls&amp;do=results'>View Poll Results</a></center>";
...
if ($action=="polls" && $do=="add"){
	...
	begin_framec("Polls");
	?>                                                
    <form method="post" action="modocp.php?action=polls&amp;do=save"> 
...
if ($action=="torrentlangs" && $do=="view"){
	...
	echo "<center><a href='modocp.php?action=torrentlangs&amp;do=add'><b>Add New Language</b></a></center><br />";
	...
	while ($row = mysql_fetch_array($sql)) {
		...
		if (isset($row["image"]) && $row["image"] != "")
			...
			print("-");	
		print("</td><td class='table_col1'><a href='modocp.php?action=torrentlangs&amp;do=edit&amp;id=$id'>[EDIT]</a> <a href='modocp.php?action=torrentlangs&amp;do=delete&amp;id=$id'>[DELETE]</a></td></tr>");
	}
	echo("</table></center>");
	end_framec();
	stdfoot();
...
if ($action=="avatars"){
	...
	list($pagertop, $pagerbottom, $limit) = pager(50, $count, 'modocp.php?action=avatars&amp;');
	echo ($pagertop);
	?>
	<table border="0" class="table_table" align="center">
	<tr>
	<th class="ttable_head"><?php echo T_("USER")?></th>
	<th class="ttable_head">Avatar</th>
	</tr><?php
	...
	while($arr = mysql_fetch_array($res)){
			...
			if (!$arr['avatar'])
				...
				echo "<img  src=\"".htmlspecialchars($arr["avatar"])."\" alt='' /></td></tr>";
	}
	?>
	</table>
	<?php
...
if ($action=="bannedtorrents"){
	...
	list($pagertop, $pagerbottom, $limit) = pager($perpage, $count, "modocp.php?action=bannedtorrents&amp;");
...
if ($action=="masspm"){
    ...
    print("<form name='masspm' method='post' action='modocp.php?action=masspm&amp;send=1'>\n"); 
...
if ($action=="rules" && $do=="view"){
	...
	print("<center><a href='modocp.php?action=rules&amp;do=addsect'>Add New Rules Section</a></center><br />\n");	
	...
	while ($arr=mysql_fetch_assoc($res)){
        ...
        print("<div>");
        print("<form method='post' action='modocp.php?action=rules&amp;do=edit'><table width='100%' border='0'>");
...
if ($action=="rules" && $do=="edit"){
	...
	if ($_GET["save"]=="1"){
		...
		show_error_msg(T_("COMPLETE"), "Rules edited ok<br /><br /><a href='modocp.php?action=rules&amp;do=view'>Back To Rules</a>",1);
		die;
	}
	...
	print("<form method=\"post\" action=\"modocp.php?action=rules&amp;do=edit&amp;save=1\">");
...
if ($action=="rules" && $do=="addsect"){
	...
	if ($_GET["save"]=="1"){
		...
		show_error_msg(T_("COMPLETE"), "New Section Added<br /><br /><a href='modocp.php?action=rules&amp;do=view'>Back To Rules</a>",1);
		die();
	}
	stdhead(T_("SITE_RULES_EDITOR"));
	navmenu();
	begin_framec(T_("ADD_NEW_RULES_SECTION"));
	print("<form method=\"post\" action=\"modocp.php?action=rules&amp;do=addsect&amp;save=1\">");
	print("<table border=\"0\" cellspacing=\"0\" cellpadding=\"10\" align=\"center\">\n");
...
if ($action == "reports" && $do == "view") {
      ...
      $page = 'modocp.php?action=reports&amp;do=view&amp;';
      ...
      if ($_POST["mark"])
      {
          ...
          header("Refresh: 2; url=modocp.php?action=reports&do=view");
      ...
      <form id="reports" method="post" action="modocp.php?action=reports&amp;do=view">
...
if ($action == "warned")
{
    if ($do == "delete") 
    {
        ...
        autolink("modocp.php?action=warned", "Entries Confirmed");
    }
    
    $count = get_row_count("users", "WHERE enabled = 'yes' AND status = 'confirmed' AND warned = 'yes'");
    
    list($pagertop, $pagerbottom, $limit) = pager(25, $count, 'modocp.php?action=warned&amp;');
    ...
    <?php if ($count > 0): ?>
    <br />
    <form id="warned" method="post" action="modocp.php?action=warned&amp;do=delete">
    <table border="0" cellpadding="3" cellspacing="0" width="100%" align="center" class="table_table">
    <tr>
        <th class="table_head">Username</th>
...
if ($action == "confirmreg")
{
    if ($do == "confirm") 
    {
        ...
        autolink("modocp.php?action=confirmreg", "Entries Confirmed");
    }
    
    $count = get_row_count("users", "WHERE status = 'pending' AND invited_by = '0'");
    
    list($pagertop, $pagerbottom, $limit) = pager(25, $count, 'modocp.php?action=confirmreg&amp;'); 
    ...
    <?php if ($count > 0): ?>
    <br />
    <form id="confirmreg" method="post" action="modocp.php?action=confirmreg&amp;do=confirm">
    <table border="0" cellpadding="3" cellspacing="0" width="100%" align="center" class="table_table">
    <tr>
        <th class="table_head">Username</th>
...
if ($action == "pendinginvite")
{
    if ($do == "del") 
    {
        ...
        autolink("modocp.php?action=pendinginvite", "Entries Deleted");
    }
    
    $count = get_row_count("users", "WHERE status = 'pending' AND invited_by != '0'");
    
    list($pagertop, $pagerbottom, $limit) = pager(25, $count, 'modocp.php?action=pendinginvite&amp;');  
    ...
    <?php if ($count > 0): ?>
    <br />
    <form id="pendinginvite" method="post" action="modocp.php?action=pendinginvite">
...
if ($action == "invited")
{
    if ($do == "del") 
    {
        ...
        autolink("modocp.php?action=invited", "Entries Deleted");
    }
    
    $count = get_row_count("users", "WHERE status = 'confirmed' AND invited_by != '0'");
    
    list($pagertop, $pagerbottom, $limit) = pager(25, $count, 'modocp.php?action=invited&amp;');  
    ...
    <?php if ($count > 0): ?>
    <br />
    <form id="invited" method="post" action="modocp.php?action=invited">
...
if ($action == "users")
{
    if ($CURUSER['delete_users'] == 'no' || $CURUSER['delete_torrents'] == 'no')
        autolink("modocp.php", "You do not have permission to be here.");
    ...
    if ($do == "del") 
    {
        ...
        autolink("modocp.php?action=users", "Entries Deleted");
    }
    ...
    list($pagertop, $pagerbottom, $limit) = pager(25, $count, 'modocp.php?action=users&amp;');  
    ...
    <?php if ($count > 0): ?>
    <br />
    <form id="usersearch" method="post" action="modocp.php?action=users">
    <input type="hidden" name="do" value="del" />
    <table border="0" cellpadding="3" cellspacing="0" width="100%" align="center" class="table_table">
    <tr>
        <th class="table_head">Username</th>
...
#======================================================================#
  if ($action == 'sqlerr')
  {
      if ($_POST['do'] == 'delete')
      {
          ...
          autolink("modocp.php?action=sqlerr", "Entries deleted.");
      }
      
      
      $count = get_row_count('sqlerr');
      
      list($pagertop, $pagerbottom, $limit) = pager(25, $count, 'modocp.php?action=sqlerr&amp;');
      ...
      if ($count > 0): ?>
      <form id="sqlerr" method="post" action="modocp.php?action=sqlerr">
      <input type="hidden" name="do" value="delete" />
...
if ($action == "privacylevel")
{
    ...
    <tr>
        ...
        <form id='sort' action=''>
        <b>Privacy Level:</b>
        <select name="type" onchange="window.location='modocp.php?action=privacylevel&type='+this.options[this.selectedIndex].value">
...
<form method="post" action="modocp.php?action=censor">  
...
switch ($to)
  {
    ...
    default:
      ...
      @fclose($f);
	  begin_framec($LANG['ACP_CENSORED']);
      echo'<form action="modocp.php?action=censor&to=write" method="post" enctype="multipart/form-data">
...
if ($action == "ipbans") {
    ...
    print("<b>No Bans Found</b><br />\n");
        ...
        list($pagertop, $pagerbottom, $limit) = pager(50, $count, "modocp.php?action=ipbans&amp;"); // 50 per page
        echo $pagertop;

        echo "<form id='ipbans' action='modocp.php?action=ipbans&amp;do=del' method='post'><table width='98%' cellspacing='0' cellpadding='5' align='center' class='table_table'>
        <tr>
    ...
    echo "<br />";
    print("<form method='post' action='modocp.php?action=ipbans&amp;do=add'>\n");
...
#======================================================================#
 if ($action == "seedbonus" && $do != "change")
 {
    if ($do == "del")
    {
            ...
            autolink("modocp.php?action=seedbonus", "Entries Deleted");
    }
 
    $count = get_row_count("seedbonus");
 
    list($pagertop, $pagerbottom, $limit) = pager(25, $count, 'modocp.php?action=seedbonus&amp;');
    ...
    <center>
    This page displays all available trade options which users can trade their seedbonus for. <?php echo number_format($count); ?> trade options; <a href="modocp.php?action=seedbonus&amp;do=change&amp;id=null">Add</a> new option?
    </center>
    
    <?php if ($count > 0): ?>
    <br />
    <form id="seedbonus" method="post" action="modocp.php?action=seedbonus">
    <input type="hidden" name="do" value="del" />
    <table border="0" cellpadding="3" cellspacing="0" width="100%" align="center" class="table_table">
    <tr>
            <th class="table_head">Title</th>
            <th class="table_head">Descr</th>
            <th class="table_head">Cost</th>
            <th class="table_head">Value</th>
            <th class="table_head">Type</th>
            <th class="table_head">Edit</th>
            <th class="table_head"><input type="checkbox" name="checkall" onclick="checkAll(this.form.id);" /></th>
    </tr>
    ...
    <tr>
           ...
           <td class="table_col2" align="center"><a href="modocp.php?action=seedbonus&amp;do=change&amp;id=<?php echo $row->id; ?>">Edit</a></td>
  ...
  if ($action == "seedbonus" && $do == "change")
  {
          ...
          {     
                   ...
                   autolink("modocp.php?action=seedbonus", "Updated seedbonus.");
          }
          ...
          <form method="post" action="modocp.php?action=seedbonus&amp;do=change">
          ...
          <tr>
                  <th class="table_head" colspan="2">Seedbonus Management</th>
          </tr>
          <tr>
...
if ($action == "usersearch") {
	...
	if ($_GET['h']) {
		...
		echo "<p align='center'>[<a href='modocp.php?action=usersearch&amp;h=1'>Instructions</a>]";
		echo "&nbsp;-&nbsp;[<a href='modocp.php?action=usersearch'>Reset</a>]</p>\n";
	}
...
<?php
	...
	if (count($_GET) > 0 && !$_GET['h']) {
        ...
        # To Avoid Confusion we skip invite_* which are invited users which haven't confirmed yet, visit modocp.php?action=pendinginvited
        $where_is .= (isset($where_is))?" AND ":"";   
		...
		list($pagertop, $pagerbottom, $limit) = pager($perpage, $count, "modocp.php?action=usersearch&amp;$q");
		...
		show_error_msg("Warning","No user was found.", 0);
            ...
            echo "<form action='modocp.php?action=usersearch&amp;do=warndisable' method='post'>";
...
if ($action == "forum") {
    ...
    if ($_POST["do"] == "add_this_forum") {
        ...
        if ($error_ac == "") {
            ...
            if ($res)
                autolink("modocp.php?action=forum", "Thank you, new forum added to db ...");
            else
    ...
    if ($_POST["do"] == "add_this_forumcat") {
        ...
        if ($error_ac == "") {
            ...
            if ($res)
                autolink("modocp.php?action=forum", "Thank you, new forum cat added to db ...");
            else
                echo "<h4>Could not save to DB - check your connection & settings!</h4>";
        } 
    }
    ...
    if ($_POST["do"] == "save_edit") {
        ...
        autolink("modocp.php?action=forum", "<center><b>Update Completed</b></center>");
    }
    ...
    if ($_POST["do"] == "delete_forum" && is_valid_id($_POST["id"])) 
    {
        ...
        autolink("modocp.php?action=forum", "forum deleted ...");
    }
    ...
    if ($_POST["do"] == "delete_forumcat" && is_valid_id($_POST["id"])) 
    {
        ...
        autolink("modocp.php?action=forum", "forum cat deleted ...");
    }
    ...
    if ($_GET["do"] == "edit_forum") {
        ...
        if (!$r)
             autolink("modocp.php?action=forum", "Invalid Forum.");
        
        begin_framec("Edit Forum");   
    ?>
          <form action="modocp.php?action=forum" method="post">
...
?>
    <form class='a-form' action="modocp.php?action=forum" method="post">
...
if ($_GET["do"] == "del_forumcat") {
    ...
    if (!$v)
         autolink("modocp.php?action=forum", "Invalid Forum Category.");
...
if ($allforums == 0) {
    ...
    while($row = mysql_fetch_array($query)) {
        foreach ($forumcat as $cat)
            ...
            echo "<td class='f-border' width='18'><a href='modocp.php?action=forum&amp;do=edit_forum&amp;id=$row[id]'>[Edit]</a></td>\n";
            echo "<td class='f-border' width='18'><a href='modocp.php?action=forum&amp;do=del_forum&amp;id=$row[id]'><img src='images/delete.gif' alt='Delete  Category' width='17' height='17' border='0' /></a></td></tr>\n";
    }
}
echo "</table>
...
if ($allcat == 0) {
    ...
    foreach ($forumcat as $row) {
        ...
        echo "<td class='f-border' width='18'><a href='modocp.php?action=forum&amp;do=edit_forumcat&amp;id=$row[id]'>[Edit]</a></td>\n";
        echo "<td class='f-border' width='18'><a href='modocp.php?action=forum&amp;do=del_forumcat&amp;id=$row[id]'><img src='images/delete.gif' alt='Delete  Category' width='17' height='17' border='0' /></a></td></tr>\n";
    }
}
echo "</table>\n";
