...
class=ttable_headp align=center >Data do pedido</td>
...
".$shortname." (
<a class=\"lastpost\" href=\"#\" onclick=\"toggle1('n".$row['id']."', 'p".$row['id']."');return false;\" style=\"cursor: hand;\">mais</a>
)
</div>
<div id=\"n".$row['id']."\" style=\"display: none;\">
".htmlspecialchars($row["descr"])." (
<a class=\"lastpost\" href=\"#\" onclick=\"toggle1('n".$row['id']."', 'p".$row['id']."');return false;\" style=\"cursor: hand;\">menos</a>
)
...
if($CURUSER["level"]=="Administrador" || $CURUSER["level"]=="Sysop" || $CURUSER["level"]=="Moderador" || $CURUSER["level"]=="Liberador"){
print("<tr><td width=100% align=center colspan=6 class=tab1_col3p><input type=submit  style='width:30%; height: 25px' value='Apagar pedido'></td></tr>");
} 
print("</table>\n");
