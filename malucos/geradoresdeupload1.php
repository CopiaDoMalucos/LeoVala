...
dbconn();
loggedinonly();
stdhead("Selecione uma categoria");
begin_framec("Selecione uma categoria");
echo"<table class='tab1' cellpadding='0' cellspacing='1' align='center'>";

print("<B>Observações Importantes:</B><br>");
print("1. Os torrents devem estar de acordo com as Regras de Lançamentos.<BR>
...
4. O método de envio de torrents é totalmente sistematizado. Qualquer dúvida, entre em contato com nossa equipe nos fóruns ou no ShoutBox.<BR>");
echo"</table>";

echo'<div align="justify" class="framecentro">';
echo'<table width="100%"  class="tab1" cellpadding="0" cellspacing="1" align="center">';
echo'<td align="center" colspan="5" class="tab1_cab1">Gerador de upload</td>';
