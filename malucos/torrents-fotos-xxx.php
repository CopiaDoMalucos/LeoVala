...
$filmeidiomaorigiid = (int) $_POST["filmeidioma"];	
	...
	/////gerador filmes anos
							...
							//////////Qaulidade músicas 
	$revistatensaoid = $_POST['revistatensao1'];
...
?>
<form name="upload" enctype="multipart/form-data" action="torrents-fotos-xxx.php?cat=<?php echo $_GET["cat"] ;?>" method="post">
