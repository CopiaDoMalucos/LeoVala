...
//-------- end posts table ---------//
 ...
 print("<div align='center'>\n");
			if ($locked)
				print("Destravar: <a href='forums.php?action=unlocktopic&amp;forumid=$forumid&amp;topicid=$topicid&amp;page=$page' title='Destravar'><img src='". $themedir ."topic_unlock.png' alt='UnLock Tópico' /></a>\n");
			else
    ...
    //
        ...
        print("<tr class='f-row f-border'><td class='f-img' valign='middle'><img src='". $themedir ."$topicpic.png' alt='' />" .
	     ...
	     if ($CURUSER["edit_forum"] == "yes" || $CURUSER["delete_forum"] == "yes") {
			...
			if ($locked)
				print("<a href='forums.php?action=unlocktopic&amp;forumid=$forumid&amp;topicid=$topicid&amp;page=$page' title='Destravar'><img src='". $themedir ."topic_unlock.png' alt='UnLock Tópico' /></a>\n");
			else
				print("<a href='forums.php?action=locktopic&amp;forumid=$forumid&amp;topicid=$topicid&amp;page=$page' title='Lock'><img src='". $themedir ."topic_lock.png' alt='Bloquear Tópico' /></a>\n");
			...
			if ($sticky)
			   print("<a href='forums.php?action=unsetsticky&amp;forumid=$forumid&amp;topicid=$topicid&amp;page=$page' title='Mover'><img src='". $themedir ."folder_sticky_new.png' alt='Mover Tópico' /></a>\n");
			else
			   print("<a href='forums.php?action=setsticky&amp;forumid=$forumid&amp;topicid=$topicid&amp;page=$page' title='Mover'><img src='". $themedir ."folder_sticky.png' alt='Tópico Mover' /></a>\n");
			  print("</span></td>\n");
        }
        print("</tr>\n");
      } // while
