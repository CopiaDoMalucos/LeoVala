...
?>
<form name="upload" enctype="multipart/form-data" action="torrents-videoclipes.php?cat=<?php echo $_GET["cat"] ;?>" method="post">
...
$category .= "</select>\n";
print ("<TR><TD width=50%  align=right  class=tab1_col3>Categoria: *</td><td  width=50% align=left class=tab1_col3>".$category."</td></tr>");
...
print ("<TR><TD width=50%  align=right  class=tab1_col3>Video clipe em 3D? *</td><td  width=50% align=left class=tab1_col3>".$filme3did."</td></tr>");
/////Filme em 3D de lançamento
