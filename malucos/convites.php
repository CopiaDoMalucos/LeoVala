...
{         
		...
		<td align='left'>
                  ...
                  <p></p><center><h3><b><font face=verdana>Sistema de Convites do malucos-share:</b></h3></center><p></p>

                  Abaixo está a lista e estado atual dos seus convidados (se houver). 
                  Para convidar um novo membro para o malucos-share, clique primeiro no botão <input type='submit' value='Gerar Código do Convite' class='shoutbox_shoutbtn'> 
                    ...
                    Copie o código exatamente como aparece e envie para a pessoa que você deseja convidar para o malucos-share, juntamente com o endereço principal do site: 
                    http://www.malucos-share.org para ele se registrar. Após o cadastro o seu convidado deve ser confirmado por você. Ele não será capaz de acessar o malucos-share 
					...
					Caso o seu convidado não se registre em 7 (sete) dias o código de convite será deletado automaticamente pelo sistema.
                      ...
                      Equipe malucos-share, sempre fazendo o melhor por você!!!</font>
                      </td>
...
$body = <<<EOD
O {$CURUSER["username"]} ,membro da comunidade Malucos-Share esta convidando você, para participar do site. 
...
EOD;
	    $body1 = utf8_decode($body);
				sendmail($email, "Convite MS", $body1, "para: $site_config[SITEEMAIL]", "-f$site_config[SITEEMAIL]");
				$mailsent = 1;
...
begin_framec("Sorry!");
echo "<BR><BR><B><Center><font color=red>Convites estão desabilitados, por favor, diga aos seus amigos para usar o link de registo, para a construção de nossa comunidade.</B></CENTER></font><BR><BR>";
end_framec();
stdfoot();
exit;
}
