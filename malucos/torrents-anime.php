...
?>
<form name="upload" enctype="multipart/form-data" action="torrents-anime.php?cat=<?php echo $_GET["cat"] ;?>" method="post">
...
// screenshots //
//teste ademilson//
print ("<TR><TD width=100%  align=center colspan=2 class=tab1_col3><b>Imagens (screens) do vídeo</b><br><br>Não inclua a tag [img] nos campos abaixo.<br>Sempre use o direct link ao selecionar sua screem<br>Não serão permitidas screens que não sejam do vídeo em questão.</td><BR>\n</td></tr>"); //fim do teste
print ("<TR><TD width=50%  align=right  class=tab1_col3>Capa: *</td><td width=50%  align=left class=tab1_col3><input type=text name=screens1 size=30 value=" . $_POST['screens1'] . "> <a href=http://www.imgur.com target=_BLANK>[Hospedar imagem]</a><BR>\n</td></tr>");
...
print ("<TR><TD width=50%  align=right  class=tab1_col3>Screen 4: </td><td width=50%  align=left class=tab1_col3><input type=text name=screens5 size=30 value=" . $_POST['screens4'] . "><BR>\n</td></tr>");
//screenshots //
...
echo "<b>Sinopse:*</b><br>";
echo "<a href=http://www.adorocinema.com/filmes/todos/?status=Archived&amp;letter=A target=_BLANK>Clique aqui</a> para obter a sinopse e ficha técnica de filmes e seriados.<br><br>";
...
* Todos os campos com asterisco devem ser preenchidos.
<?php
  print("</table>\n");
end_framec();
stdfoot();
