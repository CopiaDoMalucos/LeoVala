...
?>
<form name="upload" enctype="multipart/form-data" action="torrents-apostila-cursos.php?cat=<?php echo $_GET["cat"] ;?>" method="post">
...
print ("<TR><TD width=50%  align=right  class=tab1_col3>Extensão: *</td><td width=50%  align=left class=tab1_col3>".$revistatensaoteste."</td></tr>");
/////Extensão  revista
