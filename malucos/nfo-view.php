...
if($res["nfo"] == "yes"){
    ...
    if ($nfo) {
		...
		if($CURUSER["edit_torrents"]=="yes")
            begin_framec(T_("NFO_FILE_FOR").": <a href='".$site_config["SITEURL"]."/torrents-details.php?id=$id'>$shortname</a> - <a href='nfo-edit.php?id=$id'>".T_("NFO_EDIT")."</a>");
        else
            begin_framec(T_("NFO_FILE_FOR").": $shortname");
