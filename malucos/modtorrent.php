...
///fim
$res2 = SQL_Query_exec("SELECT COUNT(*) FROM torrents WHERE safe='no' AND visible='yes' AND ". $where ."  ORDER BY added ASC");
        $row = mysql_fetch_array($res2);
        $count = $row[0];
$perpage = 19;
    list($pagertop, $pagerbottom, $limit) = pager($perpage, $count, $_SERVER["PHP_SELF"] ."?" );
$res = SQL_Query_exec("SELECT * FROM torrents WHERE safe='no' AND visible='yes' AND ". $where ."  ORDER BY added ASC $limit") or sqlerr();
...
print("<center>Todos os torrents foram aceites</center>");
end_framec();  
} 
else{
begin_framec("Torrents aguardando Aprovação");
?>
<center ><h1 size="10" >Versão beta 1.0 ainda em desenvolvimento kkkkkkkkkkk</h1></center>
<div align="right">[ <a href="#">Meus pendentes</a> | <a href="#">Já editados</a> | <a href="#">Sem mod responsavel</a> ]</div>
<?php
for ($i = 0; $i < $num; ++$i)
{
...
if($CURUSER["id"]== 1){ 
$gerenciar = "<a href='torrents-details.php?id=" . $arr["id"] . "'>Gerenciar</a>";	
}	  
else
{
$gerenciar = "<a href='#'>Gerenciar</a>";	
}	  
?>
...
<tbody>
<tr><td align="center" colspan="4" class="tab1_cab1"><a href="torrents-details.php?id=<?php echo $arr["id"] ;?>"><?php echo $torrent_name ;?> </a><br><?php echo  $cat_paret ;?> > <?php echo  $cat_paren1 ;?> - Lançado por <a href="account-details.php?id=<?php echo $row_user_torr["id"] ;?>"><?php echo $row_user_torr["username"] ;?> </a></td></tr>

<tr>


<td width="100" align="center" class="ttable_col2"><b>Lançado em</b><br><?php echo date("d/m \à\s H:i", utc_to_tz_time($arr["added"])) ;?></td>
<td width="100" align="center" class="ttable_col2"><b>Moderado</b><br><?php echo $moderadorto ;?><br><b>Tempo </b><?=$mederandotempo ?></td>
