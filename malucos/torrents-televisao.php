...
?>
<form name="upload" enctype="multipart/form-data" action="torrents-televisao.php?cat=<?php echo $_GET["cat"] ;?>" method="post">
...
print ("<TR><TD width=50%  align=right  class=tab1_col3>Tv em 3D? *</td><td width=50% align=left class=tab1_col3>".$filme3did."</td></tr>");
/////Filme em 3D de lançamento
