...
begin_framec("Torrents aguardando Aprovação <B>[Sem mod responsavel]</B>");
...
?>
<center ><h1 size="10" >Minhas estatísticas do mês</h1><br>Torrents liberados: <B><?php $liberados ;?></B> <br>Torrents deletados: <B><?php echo  $deletadosto ;?></B><br></center>
<div align="right">[ <a href="/app.php">Todos</a> | <a href="/app_meus.php">Meus pendentes</a> | <a href="/app_editados.php">Já editados</a> ] </div>
<?php
$wherea=array();
$wherea[] = "seeders > '0'";
...
///fim
   	...
   	$res = mysql_query("SELECT * FROM users  LEFT JOIN torrents ON users.id = torrents.owner WHERE users.class != '50' AND  torrents.safe = 'no' AND torrents.upupload='no' AND torrents.visible = 'yes' AND torrents.seeders > '0' ORDER BY torrents.added ASC");     
...
<tbody>
<tr><td align="center" colspan="4" class="tab1_cab8"><a href="torrents-details.php?id=<?php echo $arr["id"] ;?>"><?php $torrent_name ;?> </a><br><?php echo $cat_paret ;?> > <?php echo  $cat_paren1 ;?> - Lançado por <a href="account-details.php?id=<?php echo $row_user_torr["id"] ;?>"><?php echo $row_user_torr["username"] ;?> </a></td></tr>

<tr>


<td width="100" align="center" class="ttable_col2"><b>Lançado em</b><br><?php echo date("d/m \à\s H:i", utc_to_tz_time($arr["added"])) ;?></td>
<td width="100" align="center" class="ttable_col2"><b>Moderado</b><br><?php echo $moderadorto ;?><br><b>Tempo </b><?php echo $mederandotempo ; ?></td>
...
if($nummod == '0')
{
	...
	show_error_msg("Erro", "<center>Não temos torrent sem mod responsavel</center>");
