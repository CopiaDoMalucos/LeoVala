...
{ 
 ...
 <tr>
     ...
     <select name="cat" onchange="window.location='grupo-rank.php?id=<?php echo $id; ?>&duration=<?php echo ($_GET['duration']); ?>&amp;cat='+this.options[this.selectedIndex].value">
...
if ($_GET["duration"] == 1) {
 ...
 ?>
  <center>
 <a href="grupo-rank.php?id=<?php echo $id; ?>">Top 10 Total</a> | <a href="grupo-rank.php?id=<?php echo $id; ?>&amp;duration=<?php echo 1; ?>">Top 10 Mensal</a> | <a href="grupo-rank.php?id=<?php echo $id; ?>&amp;duration=<?php echo 2; ?>">Top 10 Semanal</a>
 </center>
 ...
 <tr>
     <td class="tttable_col2" colspan="5" align="center"><b>Total de registros encontrados com este critério: 0</b></td>
 </tr>
 <?php endif; ?>
 </table>
