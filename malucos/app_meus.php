...
begin_framec("Torrents aguardando Aprovação <B>[Meus pendentes]</B>");
...
<div align="right">[ <a href="/app.php">Todos</a> | <a href="/app_editados.php">Já editados</a> | <a href="/app_semmod.php">Sem mod responsavel</a> ]</div>
...
$semmod = mysql_query("SELECT * FROM moderation WHERE uid = " . $CURUSER["id"] ." ") or sqlerr();	
...
$res = mysql_query("SELECT * FROM torrents WHERE safe='no'  AND visible='yes'   AND ". $where ."  AND id =  ".$opfor."  ORDER BY added ASC") or sqlerr();
