...
if ($deleteidtorr !=""){
	...
	write_loguser("Torrents-deletados","#FF0000","O torrent [url=http://www.malucos-share.org/torrents-details.php?id=".$deleteidtorr."]".$torrentname."[/url] foi deletado por [url=http://www.malucos-share.org/account-details.php?id=".$CURUSER["id"]."]".$CURUSER["username"]."[/url] Razão: $takereason\n");
...
http://www.malucos-share.org/torrents-edit.php?id=".$row["id"]."
