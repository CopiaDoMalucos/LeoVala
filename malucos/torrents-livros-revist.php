...
//////////gerador filmes anos
	...
	/////gerador filmes anos
							...
							//////////Qaulidade músicas 
	$revistatensaoid = (int) $_POST["revistatensao1"];	
	if (!is_valid_id($revistatensaoid ))
...
?>
<form name="upload" enctype="multipart/form-data" action="torrents-livros-revist.php?cat=<?php echo $_GET["cat"] ;?>" method="post">
...
print ("<TR><TD width=50%  align=right  class=tab1_col3>Idioma: *</td><td align=left class=tab1_col3>".$idiomafilme."</td></tr>");
/////Filme Idioma Original de lançamento



///// Extensão revista
$revistatensaoteste = "<select name=\"revistatensao1\">\n<option value=\"0\">Escolher</option>\n";

$revistatensaoqt = revistalist();
foreach ($revistatensaoqt as $row)
	$revistatensaoteste .= "<option value=\"" . $row["id"] . "\">" . htmlspecialchars($row["name"]) . "</option>\n";

$revistatensaoteste .= "</select>\n";

print ("<TR><TD width=50%  align=right  class=tab1_col3>Extensão: *</td><td align=left class=tab1_col3>".$revistatensaoteste."</td></tr>");
/////Extensão  revista




print ("<TR><TD width=50%  align=right  class=tab1_col3>Autor: *</td><td align=left class=tab1_col3><input type=text name=musicalbumlt size=60 value=" . $_POST['musicalbumlt'] . "><BR>\n</td></tr>");
