...
$site_config['SITEEMAIL'] = 'contas@malucos-share.org';		//Emails will be sent from this address
...
$site_config['OFFLINEMSG'] = 'O site malucos-share.org em manutenção. Por favor, aguarde. 5 minutos já voltamos';	

$site_config['WELCOMEPMON'] = true;			//Auto PM New members
$site_config['WELCOMEPMMSG'] = 'Seja Bem Vindo ao Malucos-Share! Antes de navegar pelo site, leia as [url=http://www.malucos-share.org/rules.php]Regras [/url] e a [url=http://www.malucos-share.org/faq.php]Ajuda[/url], Lembre-se de manter o seu rátio igual ou superior a 1,00, para mais informações procure a [url=http://www.malucos-share.org/staff.php]Equipe[/url] do site.
...
$site_config["mail_smtp_pass"] = "1g2a3b4r5i6e7l##123"; // SMTP password
