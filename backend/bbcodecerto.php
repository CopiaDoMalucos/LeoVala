...
function textbbcode($form,$name,$dossier,$content="") {
?>
...
<script language=javascript>
  ...
  if(typeof document.selection != 'undefined') 
	...
	function wrap(v,r,e)
	{
		...
		var obj = document.getElementById("<?php echo $name ;?>");
	...
	function clink()
	{
		...
		linkAddr = prompt("<?php echo"".Please_enter_the_full_URL."";?>","http://");
	...
	{
		var link;
				link = prompt("<?php echo"".Please_enter_the_full_URL_for_your_image."";?>\n<?php echo"".Only."";?> .png, .jpg, .gif images","http://");
		var re_text = /\.jpg|\.gif|\.png|\.jpeg/i;
		if(re_text.test(link) == false && link != "http://" && link) {
				alert("<?php echo"".Image_not_allowed_only."";?> .jpg .gif .png .jpeg");
				link = prompt("<?php echo"".Please_enter_the_full_URL_for_your_image."";?>\n<?php echo"".Only."";?> .png, .jpg, .gif images","http://");
				}
	  if(link != "http://" && link)
		wrap('img',link,'');
	...
	{
		var email = ""; 
		email = prompt("<?php echo"".Please_enter_the_email_addres."";?>"," ");
		var filter = /^[\w.-]+@([\w.-]+\.)+[a-z]{2,6}$/i;
		if (!filter.test(email) && email.length > 1) {
			alert("<?php echo"".Please_provide_a_valid_email_address."";?>");
			email = prompt("<?php echo"".Please_enter_the_email_addres."";?>"," ");
		}
		if(email.length > 1)
		wrap('mail',email,'');
	...
	function text2(to)
	{
		...
		{
			var str = document.selection.createRange().text2;
			obj.focus();
			var sel = document.selection.createRange();
			sel.text2 = (to == 'up' ? str.toUpperCase() : str.toLowerCase())
        }
			else 
		{
			var len = obj.value.length;
...
<table cellpadding="5" cellspacing="0" align="center"  border="1" class="bb_holder">
  <tr>
    <td width="100%" style="background:#CCCCCC; padding:0" colspan="2">
		...
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_bold1.gif" onclick="bbcomment('[b]', '[/b]')" title="Negrito" alt="Gras"/>
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_italic.gif"  onclick="bbcomment('[i]', '[/i]')" title="Italico" alt="Italique" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_underline.gif"  onclick="bbcomment('[u]', '[/u]')" title="Sublinhado" alt="Souligne" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_blink.gif" onclick="bbcomment('[blink]', '[/blink]')" title="Pisca" alt="Blink" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_marquee.gif" onclick="bbcomment('[df]', '[/df]')" title="Defile" alt="Defile" />
		
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_url.gif" onclick="clink()" title="Link" alt="Lien" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_image.gif" onclick="cimage()" title="Adcionar imagem" alt="Image"/> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_email.gif" onclick="mail()" title="Adcionar Email" alt="Email" /> 
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_flash.gif" onclick="bbcomment('[swf]', '[/swf]')" title="Adcionar swf" alt="swf" /> 
   		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_code.gif" onclick="bbcomment('[code]', '[/code]')" title="Adcionar Código" alt="code" /> 
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_quote.gif" onclick="bbcomment('[quote]', '[/quote]')" title="Adcionar quote" alt="quote" /> 
  		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_audio.gif" onclick="bbcomment('[audio]', '[/audio]')" title="Adcionar audio" alt="audio" /> 
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_video.gif" onclick="bbcomment('[video]', '[/video]')" title="Adcionar video" alt="video" /> 
   		</div>
   
      	<div style="float:right;padding:4px 2px 0px 0px;"> 
		
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_center.gif" onclick="bbcomment('[align=center]','[/align]')" title="Align - centre" alt="Centre" />
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_left.gif" onclick="bbcomment('[align=left]','[/align]')" title="Align - gauche" alt="Gauche" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_justify.gif" onclick="bbcomment('[align=justify]','[/align]')" title="Align - justifie" alt="justifie" />
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier;?>/bbcode_right.gif" onclick="bbcomment('[align=right]','[/align]')" title="Align - Droite" alt="Droite" /> 
    ...
    <td width="100%" style="background:#CCCCCC; padding:0;" colspan="2">
    	<div style="float:left;padding:4px 0px 0px 2px;">
			...
			<select name="size"  class="bb_icon" style="padding-bottom:3px;" onchange="bbsize(this.value);" title="Taille">
				<option value="1"><?php echo"".Tamanho."";?></option>
				<option value="1">1</option>
				<option value="2">2</option>
				<option value="3">3</option>
				</select>
        
			<select name="couleur" class="bb_icon" style="padding-bottom:3px;" onChange="bbcouleur2(this.value);">
				<option ><?php echo"".Cores."";?></option>
			...
			<select name="imgvar"  class="bb_icon" style="padding-bottom:3px;" onchange="bbimgvar(this.value);">
				<option value="50"><?php echo"".Tamanho_da_imagem."";?></option>
     	 ...
     	 <div style="float:right;padding:4px 2px 0px 0px;"> 
      		<img class="bb_icon" src="images/bbcode/text_uppercase.png" onclick="text2('up')" title="Caixa Alta" alt="Up" /> 
        	<img class="bb_icon" src="images/bbcode/text_lowercase.png" onclick="text2('low')" title="Caixa Baixa" alt="Low" /> 
        	...
        	<img class="bb_icon" src="images/bbcode/zoom_out.png" onclick="fonts('down')" title="Zoom -" alt="S down" />
     		<a href="javascript: PopMoreSmiles2('<?php echo $form; ?>','<?php echo $name; ?>')"><img  class="bb_icon" src=images/bbcode/<?php echo $dossier;?>/bbcode_smilie.gif border=0 alt='Plus emoticone'></a>
		</div>
	</td>
  </tr>
  
  <tr>
    <td><textarea id="<?php echo $name ;?>" name="<?php echo $name ;?>" style="width:530px; height:250px;font-size:12px;"><?php echo $content ;?></textarea></td>
...
<center><input type="button" value="<?php echo"".Visualizar."";?>" onClick="visualisation()"></center>
	</td>
	</tr>
</table>
...
function textbbcode1($form1,$name1,$dossier1,$content1="") {
?>
<script language=javascript>
	function bbcomment1(repdeb1, repfin)
	{
  var input = document.forms["<?php echo $form1 ;?>"].elements["<?php echo $name1 ;?>"];
  input.focus();
  if(typeof document.selection != 'undefined') 
  		{
    var range = document.selection.createRange();
    var insText = range.text;
    range.text = repdeb1 + insText + repfin;
    range = document.selection.createRange();
    	if (insText.length == 0) 
			{	
      range.move('character', -repfin.length);
      ...
      range.moveStart('character', repdeb1.length + insText.length + repfin.length);
    		}
    range.select();
  		}
  else if(typeof input.selectionStart != 'undefined')
    ...
    var end = input.selectionEnd;
    var insText = input.value.substring(start, end);
    input.value = input.value.substr(0, start) + repdeb1 + insText + repfin + input.value.substr(end);
    var pos;
    	if (insText.length == 0) 
			{
      pos = start + repdeb1.length;
    		} 
		else{
      pos = start + repdeb1.length + insText.length + repfin.length;
    		}
    input.selectionStart = pos;
    input.selectionEnd = pos;
  		}
    ...
    input.value = input.value.substr(0, pos) + repdeb1 + insText + repfin + input.value.substr(pos);
  		}
	}
	
	function wrap1(v,r,e)
	{
		var r = r ? r : "";
		var v = v ? v : "";
		var e = e ? e : "";
		
		var obj = document.getElementById("<?php echo $name1 ;?>");
		var len = obj.value.length;
		var start = obj.selectionStart;
		var end = obj.selectionEnd;
		var sel = obj.value.substring(start, end);
	...
	function text1(to)
	{
		...
		if (document.selection)
		{
			var str = document.selection.createRange().text1;
			obj.focus();
			var sel = document.selection.createRange();
			sel.text1 = (to == 'up' ? str.toUpperCase() : str.toLowerCase())
        }
			else 
		{
			var len = obj.value.length;
	...
	function PopMoreSmiles1(form,name) 
	{
         link='backend/smilies.php?action=display&form='+form+'&text='+name
         newWin=window.open(link,'moresmile','height=600,width=160,resizable=no,scrollbars=yes');
         if (window.focus) {newWin.focus()}
	...
	function bbcouleur1(couleur) 
	{
		bbcomment1("[color="+couleur+"]", "[/color]");
	}
	
	function bbfont1(font) 
	{
		bbcomment1("[font="+font+"]", "[/font]");
	}
	
	function bbsize1(taille) 
	{
		bbcomment1("[size="+taille+"]", "[/size]");
	}
	function bbimgvar1(tailleimgvar) 
	{
		bbcomment1("[fil="+tailleimgvar+"]", "[/fil]");
	}
	var timer=0;
	var ptag=String.fromCharCode(5,6,7);
	
	function  visualisation1() {
	t=document.forms["<?php echo $form1 ;?>"].elements["<?php echo $name1 ;?>"].value  
	t=code_to_html(t)
	if (document.getElementById) document.getElementById("previsualisation1").innerHTML=t
	if (document.formu.auto.checked) timer=setTimeout(visualisation1,1000)
								}
...
// balise quote=
	t=deblaie(/(\[\/quote\])/g,t)
	t=remplace_tag(/\[quote=([a-zA-Z]+)\]((\s|.)+?)\[\/quote\]/g,'<p class=sub><b>$1 a ecrit:</b></p><table class=main border=1 cellspacing=0 cellpadding=10><tr><td style="border: 1px black dotted">$2</td></tr></table>',t)  
	t=remblaie(t)
;
// balise blink	
	t=deblaie(/(\[\/blink\])/g,t)
...
<table cellpadding="5" cellspacing="0" align="center"  border="1" class="bb_holder">
  <tr>
    <td width="100%" style="background:#CCCCCC; padding:0" colspan="2">
		...
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_bold1.gif" onclick="bbcomment1('[b]', '[/b]')" title="Negrito" alt="Gras"/>
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_italic.gif"  onclick="bbcomment1('[i]', '[/i]')" title="Italique" alt="Italique" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_underline.gif"  onclick="bbcomment1('[u]', '[/u]')" title="Souligne" alt="Souligne" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_blink.gif" onclick="bbcomment1('[blink]', '[/blink]')" title="Blink" alt="Blink" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_marquee.gif" onclick="bbcomment1('[df]', '[/df]')" title="Defile" alt="Defile" />
		
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_url.gif" onclick="clink1()" title="Lien" alt="Lien" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_image.gif" onclick="cimage1()" title="Image" alt="Image"/> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_email.gif" onclick="mail1()" title="Email" alt="Email" /> 
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_flash.gif" onclick="bbcomment1('[swf]', '[/swf]')" title="swf" alt="swf" /> 
   		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_code.gif" onclick="bbcomment1('[code]', '[/code]')" title="code" alt="code" /> 
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_quote.gif" onclick="bbcomment1('[quote]', '[/quote]')" title="quote" alt="quote" /> 
  		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_audio.gif" onclick="bbcomment1('[audio]', '[/audio]')" title="audio" alt="audio" /> 
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_video.gif" onclick="bbcomment1('[video]', '[/video]')" title="video" alt="video" /> 
   		</div>
   
      	<div style="float:right;padding:4px 2px 0px 0px;"> 
		
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_center.gif" onclick="bbcomment1('[align=center]','[/align]')" title="Align - centre" alt="Centre" />
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_left.gif" onclick="bbcomment1('[align=left]','[/align]')" title="Align - gauche" alt="Gauche" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_justify.gif" onclick="bbcomment1('[align=justify]','[/align]')" title="Align - justifie" alt="justifie" />
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier1;?>/bbcode_right.gif" onclick="bbcomment1('[align=right]','[/align]')" title="Align - Droite" alt="Droite" /> 
  ...
  <tr>
    <td width="100%" style="background:#CCCCCC; padding:0;" colspan="2">
    	<div style="float:left;padding:4px 0px 0px 2px;">
    		<select name="font"   class="bb_icon" style="padding-bottom:3px;" onChange="bbfont1(this.value);" title="Font">
          		<option value="Arial">Font</option>
 	         	<option value="Arial" style="font-family: Arial;">Arial</option>
    	      	<option value="Arial Black" style="font-family: Arial Black;">Arial Black</option>
        	  	<option value="Comic Sans MS" style="font-family: Comic Sans MS;">Comic Sans MS</option>
			...
			<select name="size"  class="bb_icon" style="padding-bottom:3px;" onchange="bbsize1(this.value);" title="Taille">
				<option value="1"><?php echo"".Size."";?></option>
				<option value="1">1</option>
				<option value="2">2</option>
				<option value="3">3</option>
			...
			<select name="couleur" class="bb_icon" style="padding-bottom:3px;" onChange="bbcouleur1(this.value);">
				...
				<option value=orangered style=color:orangered>orange-rouge</option>
				<option value=crimson style=color:crimson>crimson</option>
				<option value=red style=color:red>rouge</option>
				<option value=firebrick style=color:firebrick>rouge brique</option>
				<option value=darkred style=color:darkred>rouge<?php echo"".fonce."";?></option>
				<option value=green style=color:green>vert</option>
				<option value=limegreen style=color:limegreen>limegreen</option>
				<option value=seagreen style=color:seagreen>sea-green</option>
				<option value=deeppink style=color:deeppink>deeppink</option>
				<option value=tomato style=color:tomato>tomate</option>
				...
				<option value=chocolate style=color:chocolate>chocolat</option>
				<option value=teal style=color:teal>teal</option>
				<option value=silver style=color:silver>argent</option>
			</select>
    		
			<select name="imgvar"  class="bb_icon" style="padding-bottom:3px;" onchange="bbimgvar1(this.value);">
				<option value="50"><?php echo"".Image_size."";?></option>
				<option value="50">50</option>
				<option value="100">100</option>
				<option value="150">150</option>
				<option value="200">200</option>
     	 ...
     	 <div style="float:right;padding:4px 2px 0px 0px;"> 
      		<img class="bb_icon" src="images/bbcode/text_uppercase.png" onclick="text1('up')" title="Majuscule" alt="Up" /> 
        	<img class="bb_icon" src="images/bbcode/text_lowercase.png" onclick="text1('low')" title="Minuscule" alt="Low" /> 
        	<img class="bb_icon" src="images/bbcode/zoom_in.png" onclick="1fonts('up')" title="Zoom +" alt="S up" /> 
        	<img class="bb_icon" src="images/bbcode/zoom_out.png" onclick="1fonts('down')" title="Zoom -" alt="S down" />
     		<a href="javascript: PopMoreSmiles1('<?php echo $form1; ?>','<?php echo $name1; ?>')"><img  class="bb_icon" src=images/bbcode/<?php echo $dossier1;?>/bbcode_smilie.gif border=0 alt='Plus emoticone'></a>
		</div>
	</td>
  </tr>
  
  <tr>
    <td><textarea id="<?php echo $name1 ; ?>" name="<?php echo $name1 ;?>" style="width:530px; height:250px;font-size:12px; " > <?php echo $content1 ;?></textarea></td>
	<td align="center" valign="top">
		<table width="0" cellpadding="2" border="1" class="em_holder" cellspacing="2">
		<tr>
      <td align="center"><a href="javascript:em1(':smile1');" ><img border="0" alt=" " src="images/smilies/smile1.gif" width="18" height="18" /></a></td>
      <td align="center"><a href="javascript:em1(':smile2');" ><img border="0" alt=" " src="images/smilies/smile2.gif" width="18" height="18" /></a></td>
      <td align="center"><a href="javascript:em1(':grin');" ><img border="0" alt=" " src="images/smilies/grin.gif" width="18" height="18" /></a></td>
      <td align="center"><a href="javascript:em1(':w00t');" ><img border="0" alt=" " src="images/smilies/w00t.gif" width="18" height="20" /></a></td>
    </tr>
    <tr>
      <td align="center"><a href="javascript:em1(':tongue');" ><img border="0" alt=" " src="images/smilies/tongue.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':wink');" ><img border="0" alt=" " src="images/smilies/wink.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':n_oexpression');" ><img border="0" alt=" " src="images/smilies/noexpression.gif" width="18" height="18" /></a></td>
      <td align="center"><a href="javascript:em(':confused');" ><img border="0" alt=" " src="images/smilies/confused.gif" width="18" height="18" /></a></td>
    </tr>
    <tr>
      <td align="center"><a href="javascript:em1(':sad');" ><img border="0" alt=" " src="images/smilies/sad.gif" width="18" height="18" /></a></td>
      <td align="center"><a href="javascript:em1(':baby');" ><img border="0" alt=" " src="images/smilies/baby.gif" width="20" height="22" /></a></td>
      <td align="center"><a href="javascript:em1(':ohmy');" ><img border="0" alt=" " src="images/smilies/ohmy.gif" width="18" height="18" /></a></td>
      <td align="center"><a href="javascript:em(':s_leeping');" ><img border="0" alt=" " src="images/smilies/sleeping.gif" width="20" height="27" /></a></td>
    </tr>
    <tr>
      <td align="center"><a href="javascript:em1(':cool1');" ><img border="0" alt=" " src="images/smilies/cool1.gif" width="18" height="22" /></a></td>
      <td align="center"><a href="javascript:em1(':unsure');" ><img border="0" alt=" " src="images/smilies/unsure.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':closedeyes');" ><img border="0" alt=" " src="images/smilies/closedeyes.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':cool2');" ><img border="0" alt=" " src="images/smilies/cool2.gif" width="20" height="20" /></a></td>
    </tr>
    <tr>
      <td align="center"><a href="javascript:em1(':thumbsup');" ><img border="0" alt=" " src="images/smilies/thumbsup.gif"  /></a></td>
      <td align="center"><a href="javascript:em1(':blush');" ><img border="0" alt=" " src="images/smilies/blush.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':yes');" ><img border="0" alt=" " src="images/smilies/yes.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':no');" ><img border="0" alt=" " src="images/smilies/no.gif" width="20" height="20" /></a></td>
    </tr>
    <tr>
      <td align="center"><a href="javascript:em1(':love');" ><img border="0" alt=" " src="images/smilies/love.gif" width="19" height="19" /></a></td>
      <td align="center"><a href="javascript:em1(':question');" ><img border="0" alt=" " src="images/smilies/question.gif" width="19" height="19" /></a></td>
      <td align="center"><a href="javascript:em1(':excl');" ><img border="0" alt=" " src="images/smilies/excl.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':idea');" ><img border="0" alt=" " src="images/smilies/idea.gif" width="19" height="19" /></a></td>
    </tr>
    <tr>
      <td align="center"><a href="javascript:em1(':arrow');" ><img border="0" alt=" " src="images/smilies/arrow.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':ras');" ><img border="0" alt=" " src="images/smilies/ras.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':hmm');" ><img border="0" alt=" " src="images/smilies/hmm.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':laugh');" ><img border="0" alt=" " src="images/smilies/laugh.gif" width="20" height="20" /></a></td>
    </tr>
    <tr>
      <td align="center"><a href="javascript:em1(':mario');" ><img border="0" alt=" " src="images/smilies/mario.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':rolleyes');" ><img border="0" alt=" " src="images/smilies/rolleyes.gif" width="20" height="20" /></a></td>
      <td align="center"><a href="javascript:em1(':kiss');" ><img border="0" alt=" " src="images/smilies/kiss.gif" width="18" height="18" /></a></td>
      <td align="center"><a href="javascript:em1(':shifty');" ><img border="0" alt=" " src="images/smilies/shifty.gif" width="20" height="20" /></a></td>
	</tr>
	</table>
	</td>
  </tr>
  <tr>
    <td width="100%" colspan="2">
<center><input type="button" value="<?php echo"".Preview."";?>" onClick="visualisation1()"></center>
	</td>
	</tr>
</table>
<table align="center" width="50%">
	<tr>
    	<td>
			<span id="previsualisation1"></span>
		</td>
	</tr>
</table>
<?php
