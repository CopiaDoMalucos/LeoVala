    	...
    	<div style="float:left;padding:4px 0px 0px 2px;">
     	 ...
     	 <div style="float:right;padding:4px 2px 0px 0px;"> 
        	...
        	<img class="bb_icon" src="images/bbcode/zoom_out.png" onclick="fonts('down')" title="Zoom -" alt="S down" />
     		<a href="javascript: PopMoreSmiles('<?php echo $form; ?>','<?php echo $name; ?>')"><img  class="bb_icon" src=images/bbcode/<?php echo $dossier;?>/bbcode_smilie.gif border=0 alt='Plus emoticone'></a>
		</div>
	</td>
  </tr>
  
  <tr>
    <td><textarea id="<?php echo $name ;?>" name="<?php echo $name ;?>" style="width:560px; height:230px;font-size:12px;"><?php echo $content ;?></textarea></td>
