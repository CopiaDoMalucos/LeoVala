<?php
function textbbcode2($form,$name,$dossier2,  $content="") {
?>
...
<table cellpadding="5" cellspacing="0" align="center"  border="1" class="bb_holder">
  <tr>
    <td width="100%" style="background:#CCCCCC; padding:0" colspan="2">
		...
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_bold1.gif" onclick="bbcomment('[b]', '[/b]')" title="Negrito" alt="Gras"/>
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_italic.gif"  onclick="bbcomment('[i]', '[/i]')" title="Italico" alt="Italique" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_underline.gif"  onclick="bbcomment('[u]', '[/u]')" title="Sublinhado" alt="Souligne" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_blink.gif" onclick="bbcomment('[blink]', '[/blink]')" title="Pisca" alt="Blink" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_marquee.gif" onclick="bbcomment('[df]', '[/df]')" title="Defile" alt="Defile" />
		
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_url.gif" onclick="clink()" title="Link" alt="Lien" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_image.gif" onclick="cimage()" title="Adcionar imagem" alt="Image"/> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_email.gif" onclick="mail()" title="Adcionar Email" alt="Email" /> 
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_flash.gif" onclick="bbcomment('[swf]', '[/swf]')" title="Adcionar swf" alt="swf" /> 
   		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_code.gif" onclick="bbcomment('[code]', '[/code]')" title="Adcionar C�digo" alt="code" /> 
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_quote.gif" onclick="bbcomment('[quote]', '[/quote]')" title="Adcionar quote" alt="quote" /> 
  		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_audio.gif" onclick="bbcomment('[audio]', '[/audio]')" title="Adcionar audio" alt="audio" /> 
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_video.gif" onclick="bbcomment('[video]', '[/video]')" title="Adcionar video" alt="video" /> 
   		</div>
   
      	<div style="float:right;padding:4px 2px 0px 0px;"> 
		
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_center.gif" onclick="bbcomment('[align=center]','[/align]')" title="Align - centre" alt="Centre" />
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_left.gif" onclick="bbcomment('[align=left]','[/align]')" title="Align - gauche" alt="Gauche" /> 
        <img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_justify.gif" onclick="bbcomment('[align=justify]','[/align]')" title="Align - justifie" alt="justifie" />
		<img class="bb_icon" src="images/bbcode/<?php echo $dossier2;?>/bbcode_right.gif" onclick="bbcomment('[align=right]','[/align]')" title="Align - Droite" alt="Droite" /> 
    	...
    	<div style="float:left;padding:4px 0px 0px 2px;">
     	 ...
     	 <div style="float:right;padding:4px 2px 0px 0px;"> 
        	...
        	<img class="bb_icon" src="images/bbcode/zoom_out.png" onclick="fonts('down')" title="Zoom -" alt="S down" />
     		<a href="javascript: PopMoreSmiles('<?php echo $form; ?>','<?php echo $name; ?>')"><img  class="bb_icon" src=images/bbcode/<?php echo $dossier2;?>/bbcode_smilie.gif border=0 alt='Plus emoticone'></a>
		</div>
	</td>
  </tr>
  
  <tr>
    <td><textarea id="<?php echo $name ; ?>" name="<?php echo $name ;?>" style="width:390px; height:230px;font-size:12px;"><?php echo $content ;?></textarea></td>
