...
############################################################
  ...
  <?php 
       while ($row = mysql_fetch_assoc($res)) { 
           ...
           $peers = (get_row_count("peers", "WHERE torrent = '$id' AND userid = '$row[id]'")) ? "<font color='green'>" . T_("YES") . "</font>" : "<font color='#ff0000'>" . T_("NO") . "</font>";
  ?>
       <tr>
  ...
  <p align="center"><a href="torrents-details.php?id=<?php echo $id; ?>"><?php echo T_("BACK_TO_DETAILS"); ?></a></p>
