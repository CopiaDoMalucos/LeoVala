...
<table cellpadding="5" cellspacing="0" align="center"  border="1" class="bb_holder">
  ...
  <tr>
    <td width="100%" style="background:#CCCCCC; padding:0;" colspan="2">
    <div style="float:left;padding:4px 0px 0px 2px;">
    	<select name="fontface" id="fontface"  class="bb_icon" onchange="font('font',this.value);" title="Font font">
          <option value="0">Font Teksta</option>
		...
		<select name="fontsize" id="fontsize" class="bb_icon" style="padding-bottom:3px;" onchange="font('size',this.value);" title="Font size">
			<option value="0">Font Velicina</option>
        ...
        <select name="fontcolor" id="fontcolor" class="bb_icon" style="padding-bottom:3px;" onchange="font('color',this.value);" title="Font size">
			<option value="0">Font Boje</option>
  ...
  <tr>
    ...
    <tr>
      <td align="center"><a href="javascript:em('8)');" ><img border="0" alt=" " src="images/smilies/cool1.gif" width="18" height="22" /></a></td>
    ...
    <tr>
      ...
      <td align="center"><a href="javascript:em(':huh:');" ><img border="0" alt=" " src="images/smilies/huh.gif" width="25" height="23" /></a></td>
    </tr>
    <tr>
