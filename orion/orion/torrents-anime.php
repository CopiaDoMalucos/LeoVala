...
// screenshots //
//teste ademilson//      
print ("<TR><TD width=100%  align=center colspan=2 class=ttable_col1><b>Imagens (screens) do vídeo</b><br><br>Não inclua a tag [img] nos campos abaixo.<br>Sempre use o direct link ao selecionar sua screem<br>Não serão permitidas screens que não sejam do vídeo em questão.</td><BR>\n</td></tr>"); //fim do teste
print ("<TR><TD width=50%  align=right  class=tab1_col3>Capa: *</td><td width=50%  align=left class=tab1_col3><input type=text name=screens1 size=30 value=" . $_POST['screens1'] . "> <a href=\"javascript: void(0);\" onclick=\"window.open('http://img.brshares.com/', 'Upload','width=610,height=500,resizable=no,scrollbars=yes,toolbar=no,location=no,directories=no,status=no');\">Hospedar imagem</a><BR>\n</td></tr>");
