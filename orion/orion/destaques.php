...
begin_framec(T_("DESTAQUE_MALUCOS"));
...
print"<td>";
	$img1 = "<CENTER><a href='{$site_config[SITEURL]}/torrents-details.php?id=$row[id]'><img class='expando' border='0'src='{$row[screens1]}' title=\"".$ler."\" alt=\"$altname / $cat\" height=110 width=130></a><br></b><br><a href='torrents-details.php?id=$row[id]' title='".htmlspecialchars($row["name"])."'>$smallname</a><CENTER><br>\n";
			
	print("<center>" .$img1. "</center>");
print"</td>";
