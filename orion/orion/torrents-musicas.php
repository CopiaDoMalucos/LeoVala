...
$ano = date("y", utc_to_tz_time($row['date']));
	...
	$ret = SQL_Query_exec("INSERT INTO torrents (temposeed, filename, owner, name, filmeresolucao, musicalbum, musicalinkloja, musicalautor, filmeresolucalt, screens1, screens2, screens3, screens4, screens5, descr, filmesinopse, image1, image2, category, added, mes, dia, ano, info_hash, size, numfiles, save_as, announce, external, nfo, torrentlang, filmeano, filmeaudio, filmeextensao, filmequalidade, filme3d, filmecodecvid, filmecodecaud, filmeidiomaorigi, filmeduracaoh, filmeduracaomi, legenda, apliformarq, aplicrack, musicatensao, musicaqualidade, anon, tube, last_action, userup) VALUES (".sqlesc($temposeed).",".sqlesc($fname).", '".$CURUSER['id']."', ".sqlesc($name).", ".sqlesc($filmeresolucao).",".sqlesc($musicalbumlt).",".sqlesc($musicalinklojalt).",".sqlesc($musicalautor).", ".sqlesc($filmeresolucalt).",".sqlesc($screens1).", ".sqlesc($screens2).", ".sqlesc($screens3).", ".sqlesc($screens4).", ".sqlesc($screens5).", ".sqlesc($descr).", ".sqlesc($filmesinopse).", '".$inames[0]."', '".$inames[1]."', '".$catid."', '" . get_date_time() . "', '" . $mes . "' , '" . $dia . "' , '" . $ano . "' , '".$infohash."', '".$torrentsize."', '".$filecount."', ".sqlesc($fname).", '".$announce."', '".$external."', '".$nfo."', '".$langid."', '".$filmeanoid."', '".$filmeaudioid."', '".$filmeextensaoid."', '".$filmequalidadeid."', '".$filme3did."','".$filmecodecvidid."', '".$filmecodecaudid."', '".$filmeidiomaorigiid."', '".$filmeduracaohid."', '".$filmeduracaomiid."', '".$legendaid."','".$apliformarqid."', '".$aplicrackid."', '".$musicaqualidadeid."', '".$musicatensaoid."','$anon', '".$tube."','".get_date_time()."','".$CURUSER["username"]."')");
...
//screenshots //
print ("<TR><TD width=50%  align=right  class=tab1_col3>Link de loja/site oficial: *</td><td width=50% align=left class=tab1_col3 ><input type=text name=musicalinklojalt size=30 value=" . $_POST['musicalinklojalt'] . "><BR>\n</td></tr>");
