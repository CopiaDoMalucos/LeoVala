...
<tr>
    ...
    <td align="center"><a href="admincp.php?action=freetorrents"><img src="images/admin/free_leech.png" border="0" width="32" height="32" alt="" /><br />Torrents Free<?php /*echo T_("TORRENTS_FREE_LEECH");*/ ?></a><br /></td>
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
...
<tr>
    ...
    <td align="center"><a href="admincp.php?action=users"><img src="images/admin/simple_user_search.png" border="0" width="32" height="32" alt="" /><br />Buscar Usuario<br /></a></td>  
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="admincp.php?action=privacylevel"><img src="images/admin/privacy_level.png" border="0" width="32" height="32" alt="" /><br />Nível de privacidade<br /></a></td>     
    <td align="center"><a href="admincp.php?action=pendinginvite"><img src="images/admin/pending_invited_user.png" border="0" width="32" height="32" alt="" /><br />usuários convidados Pendente <br /></a></td>    
    <td align="center"><a href="admincp.php?action=invited"><img src="images/admin/invited_user.png" border="0" width="32" height="32" alt="" /><br />Usuários convidados<br /></a></td>    
...
<tr>
    <td align="center"><a href="mass-mail.php"><img src="images/admin/massmail.jpg" border="0" width="32" height="32"><br>Email em Massa</a><BR></td>
	<td align="center"><a href="usuario-ratio-baixo.php"><img src="images/admin/ratiousuarios.jpg" border="0" width="32" height="32"><br>Usuarios com Ratio Baixo</a><BR></td>
    <td align="center"><a href="admincp.php?action=donated"><img src="images/admin/vip.png" border="0" width="32" height="32" alt="" /><br />Doacoes<br /></a></td>
	<td align="center"><a href="torrents_dead.php"><img src="images/admin/torrents-externe.png" border="0" width="32" height="32"><br />Torrents Mortos</a><br /></td>
    <td align="center"><a href="admincp.php?action=addgigs"><img src="images/admin/control_bonus.png" border="0" width="32" height="32"><br><center>Adicionar GBs</center></a><BR></td>
	</tr>
	<tr>
    <td colspan="7">&nbsp;</td>
</tr>
<tr>
<td align="center"><a href="upload-bonus.php"><img src="images/admin/upload-manager.png" border="0" width="32" height="32"><br />Upload Manager</a><br /></td>
<td align="center"><a href="admincp.php?action=seedbonus"><img src="images/admin/bunny.gif" border="0" width="32" height="32"><br />Bonus</a><BR></td>
...
stderr("Upload", "2GB de upload é enviada para todos...");
die;
}
...
?>
<center><font color=red size=2><b>Para adicionar gigs colocar no nome do usuário e quantidade, em seguida, escolher MB para megabytes ou gigabytes GB para.</b></font></center>
<p align=center><table border=0 width=100% cellspacing=0 cellpadding=0>
<tr><td class="rowhead"><b>Usuario</b></td><td class="row1"><input type="text" name="username" size="40"/></td></tr>
<tr><td class="rowhead"><b>Quantidade</b></td><td class="row1"><input type="text" name="gigs" size="5"/><select name=unit><option value=1>MB</option><option value=2>GB</option></td></tr>
...
if ($action=="categories" && $do=="view"){
	...
	echo "<center><a href='admincp.php?action=categories&amp;do=add'><b>Adicionar Nova Categoria</b></a></center><br />";

	print("<i>Por favor, note que, se nenhuma imagem for especificado, o nome da categoria será exibido</i><br /><br />");
...
if ($action=="torrentlangs" && $do=="view"){
	...
	echo "<center><a href='admincp.php?action=torrentlangs&amp;do=add'><b>Adicionar nova Linguagem</b></a></center><br />";
	...
	while ($row = mysql_fetch_array($sql)) {
		...
		if (isset($row["image"]) && $row["image"] != "")
			...
			print("-");	
		print("</td><td class='table_col1'><a href='admincp.php?action=torrentlangs&amp;do=edit&amp;id=$id'>[EDITAR]</a> <a href='admincp.php?action=torrentlangs&amp;do=delete&amp;id=$id'>[DELETAR]</a></td></tr>");
	}
	echo("</table></center>");
	end_frame();
	stdfoot();
...
if ($action=="torrentlangs" && $do=="add"){
	...
	print("<tr><td align='left'><b>Nome:</b> <input type='text' name='name' /></td></tr>\n");
	print("<tr><td align='left'><b>Numero:</b> <input type='text' name='sort_index' /></td></tr>\n");
	print("<tr><td align='left'><b>Imagem:</b> <input type='text' name='image' /></td></tr>\n");
...
if ($action == "warned")
{
    ...
    <center>
    Esta página exibe todos os usuários que estão habilitados e têm avisos ativos, eles podem ser excluídos em massa ou excluído por usuário. Por favor, note que se você excluir um aviso que era para a relação pobre, então
     isso é estender o usuário tempo deixou expirar. <?php echo number_format($count); ?> os usuários são avisados​​;
    </center>
    ...
    <tr>
        ...
        <th class="table_head">Registrado</th>  
        <th class="table_head">Ultima Visita</th>
        <th class="table_head">Aviso</th>
        <th class="table_head"><input type="checkbox" name="checkall" onclick="checkAll(this.form.id);" /></th>
    </tr>
    <?php while ($row = mysql_fetch_assoc($res)): ?>
    <tr>
