...
<tbody>
	...
	<td align="center" class="tab1_col3">3 meses (2 Meses para VIP) </td>
	...
	<tr>
	<td align="center" class="tab1_col3">BR Pontos</td>
	<td align="center" class="tab1_col3">200 BR Pontos (valor do pedido)</td>
	<td align="center" class="tab1_col3"><?php echo $seedbonus ;?> BR Pontos</td>
	...
	<td align="center" class="tab1_col3">Pelo menos 5</td>
...
print("<br>\n");
	...
	$busca = "SELECT * FROM kitpedido WHERE status='aprovado' ORDER BY added DESC";
...
for ($i = 1; $i <= $num_registos; $i++){
    $kitapp = mysql_fetch_array($result);
    //declarar variaveis
	if ($kitapp["cat"] == 2){	
echo"	
<table align='center' cellspacing='1' cellpadding='0' id='tabela1'>
<tbody><tr><td width='40%' align='right' class='tab1_cab1'>Designer: </td><td class='tab1_cab1'><a class='adenisair' href='account-details.php?id=".$kitapp['desid']."'>".$kitapp['desname']."</a></td></tr>
<tr><td align='right' class='tab1_col3'>Usuário: </td><td class='tab1_col3'><a href='account-details.php?id=<".$kitapp['userid']."'>". $kitapp['kusername']."</a></td></tr>
<tr><td align='right' class='tab1_col3'>Data do pedido: </td><td class='tab1_col3'>".date('d/m/y', utc_to_tz_time($kitapp['added'])).' às '. date('H:i:s', utc_to_tz_time($kitapp['added']))."</td></tr>
<tr><td align='right' class='tab1_col3'>Data de conclusão: </td><td class='tab1_col3'>".date('d/m/y', utc_to_tz_time($kitapp['termina'])).' às '. date('H:i:s', utc_to_tz_time($kitapp['termina']))."</td></tr>
<tr><td align='center' colspan='2' class='tab1_col3'>
<b>Avatar:</b><br><img border='0' alt='' src='".$kitapp['link_avata']."'><br><br>
<b>Assinatura:</b><br><img border='0' alt='' src='".$kitapp['link_sing']."'>
</td>
</tr></tbody></table>
<BR>";
	...
	echo"<table align='center' cellspacing='1' cellpadding='0' id='tabela1'>
<tbody><tr><td width='40%' align='right' class='tab1_cab1'>Designer: </td><td class='tab1_cab1'><a  class='adenisair' href='account-details.php?id=".$kitapp['desid']."'>".$kitapp['desname']."</a></td></tr>
<tr><td align='right' class='tab1_col3'>Usuário: </td><td class='tab1_col3'><a href='account-details.php?id=".$kitapp['userid']."'>".$kitapp['kusername']."></a></td></tr>
<tr><td align='right' class='tab1_col3'>Data do pedido: </td><td class='tab1_col3'>".date('d/m/y', utc_to_tz_time($kitapp['added'])).' às '. date('H:i:s', utc_to_tz_time($kitapp['added']))."</td></tr>
<tr><td align='right' class='tab1_col3'>Data de conclusão: </td><td class='tab1_col3'>".date('d/m/y', utc_to_tz_time($kitapp['termina'])).' às '. date('H:i:s', utc_to_tz_time($kitapp['termina']))."></td></tr>
<tr><td align='center' colspan='2' class='tab1_col3'>
<b>Avatar:</b><br><img border='0' alt='' src='".$kitapp['link_avata']."'><br><br>
<b>Assinatura:</b><br><embed src='".htmlspecialchars($kitapp['link_sing'])."' height=200 width=400>
</td>
</tr></tbody></table>
<BR>";
...
if ($pc>1) { 
   ...
   $saida .= " <span style='float: left;'><a href='?pagina=$anterior'>&lt; Página anterior</a></span>"; 
   $saida1 .= " <span style='float: center;'><a href='pedirkit.php'>Pedir kit</a>";
} 
if ($pc<$tp) { 
   $saida2 .= " <span style='float: right;'><a href='?pagina=$proximo'>Próxima página &gt;</a></span>"; 

} 
    echo " <div align='center'>".$saida."".$saida1."".$saida2."</div>"; 
