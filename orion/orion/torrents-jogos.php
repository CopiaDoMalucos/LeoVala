...
$ano = date("y", utc_to_tz_time($row['date']));
	...
	$ret = SQL_Query_exec("INSERT INTO torrents (temposeed, filename, owner, name, filmeresolucao, filmeresolucalt, screens1, screens2, screens3, screens4, screens5, descr, filmesinopse, image1, image2, category, added, mes, dia, ano, info_hash, size, numfiles, save_as, announce, external, nfo, torrentlang, filmeano, jogosgenero, jogosformato, filmeidiomaorigi, jogosmultiplay, filmeaudio, filmeextensao, filmequalidade, filme3d, filmecodecvid, filmecodecaud,  filmeduracaoh, filmeduracaomi, legenda, anon, tube, last_action, userup) VALUES (".sqlesc($temposeed).",".sqlesc($fname).", '".$CURUSER['id']."', ".sqlesc($name).", ".sqlesc($filmeresolucao).", ".sqlesc($filmeresolucalt).", ".sqlesc($screens1).", ".sqlesc($screens2).", ".sqlesc($screens3).", ".sqlesc($screens4).", ".sqlesc($screens5).", ".sqlesc($descr).", ".sqlesc($filmesinopse).", '".$inames[0]."', '".$inames[1]."', '".$catid."', '" . get_date_time() . "', '" . $mes . "' , '" . $dia . "' , '" . $ano . "' , '".$infohash."', '".$torrentsize."', '".$filecount."', ".sqlesc($fname).", '".$announce."', '".$external."', '".$nfo."', '".$langid."', '".$filmeanoid."', '".$generoid."', '".$formatoid."', '".$filmeidiomaorigiid."', '".$jogosmultiplayid."', '".$filmeaudioid."', '".$filmeextensaoid."', '".$filmequalidadeid."', '".$filme3did."','".$filmecodecvidid."', '".$filmecodecaudid."', '".$filmeduracaohid."', '".$filmeduracaomiid."', '".$legendaid."', '$anon', '".$tube."','".get_date_time()."','".$CURUSER["username"]."')");
...
// screenshots //
print ("<TR><TD width=50%  align=right  class=tab1_col3>Capa: *</td><td align=left class=tab1_col3><input type=text name=screens1 size=30 value=" . $_POST['screens1'] . "><a href=\"javascript: void(0);\" onclick=\"window.open('http://img.brshares.com/', 'Upload','width=610,height=600,resizable=no,scrollbars=yes,toolbar=no,location=no,directories=no,status=no');\">Hospedar imagem</a><BR>\n</td></tr>");
print ("<TR><TD width=50%  align=right  class=tab1_col3>Screen 1: *</td><td align=left class=tab1_col3><input type=text name=screens2 size=30 value=" . $_POST['screens2'] . "><BR>\n</td></tr>");
print ("<TR><TD width=50%  align=right  class=tab1_col3>Screen 2: *</td><td align=left class=tab1_col3><input type=text name=screens3 size=30 value=" . $_POST['screens3'] . "><BR>\n</td></tr>");
print ("<TR><TD width=50%  align=right  class=tab1_col3>Screen 3: </td><td align=left class=tab1_col3><input type=text name=screens4 size=30 value=" . $_POST['screens4'] . "><BR>\n</td></tr>");
//screenshots //
