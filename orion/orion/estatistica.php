...
function postertable($res, $frame_caption) {
	...
	echo "<tr>";
	echo "<td class=table_head width=80>Rank</td>";
...
/////////////////////////////////////////
  ...
  postertable($r, "Top 10 Comentários</font>"); echo "<br>";
  ...
  usertable($r, "Top 10 Piores compartilhadores<font class=small>(com o mínimo de 100 MB baixado)</font>"); echo "<br>";
  ...
  usertable($r, "Top 10 Melhores compartilhadores<font class=small>(com o mínimo de 100 MB baixado)</font>"); echo "<br>";

  $r = mysql_query("SELECT * FROM torrents ORDER BY seeders + leechers DESC, seeders DESC, added ASC LIMIT 10") or sqlerr();
  _torrenttable($r, "Top 10  torrents ativos</font>"); echo "<br>";
  ...
  _torrenttable($r, "Top 10 Melhor Seeded Torrents <font class=small>(com no mínimo 5 seeders)</font>"); echo "<br>";
  ...
  _torrenttable($r, "Top 10 Piores Torrents<font class=small>(com no mínimo 5 leechers)</font>"); echo "<br>";

  $r = mysql_query("SELECT * FROM users ORDER BY donated DESC, username LIMIT 100") or die;
  donortable($r, "Top 10 doadores"); echo "<br>";
  ...
  countriestable($r, "Top 10 Países</font>");echo "<br><br>";
