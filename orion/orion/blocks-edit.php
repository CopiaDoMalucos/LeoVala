...
print("<table align=\"center\" width=\"1%\"><tr><td>".
	...
	"<table class=\"table_table\" cellspacing=\"1\" width=\"100%\">".
		"<tr>".
			"<td class=\"table_head\" align=\"center\"><font size=\"2\"><b>".T_("_BLC_MAN_")."</b></font></td>".
		"</tr>".
	"</table><br />".
	"<table cellspacing=\"1\" class=\"table_table\" align=\"center\">".
		"<tr>".
...
while($blocks2 = mysql_fetch_assoc($res)){
	...
	print("<tr>".     # id=\"qq"\" - removed
		...
		"</tr>".
		"<tr>".
			"<td class=\"$class\" height=\"1%\">".((($blocks2["position"] != "left") && ($blocks2["enabled"] == 1)) ? "<a href=\"blocks-edit.php?edit=true&amp;position=left&amp;left=".$blocks2["id"]."\"><img border=\"0\" src=\"images/blocks/leftenable.gif\" width=\"18\" height=\"15\" alt=\""._MOVE_LEFT_."\" /></a>" : "<img border=\"0\" src=\"images/blocks/leftdisable.gif\" width=\"18\" height=\"15\" ".($blocks2["enabled"] ? "alt=\"".T_("_AT_LEFT_")."\"" : "alt=\""._MUST_ENB_MOVE_."\"")." ".($blocks2["enabled"] ? "onclick=\"javascript: alert('".T_("_AT_LEFT_")."');\"" : "onclick=\"javascript: alert('"._MUST_ENB_FIRST."');\"")."  />")."</td>".
			...
			"<td class=\"$class\" height=\"1%\">".((($blocks2["position"] != "right") && ($blocks2["enabled"] == 1)) ? "<a href=\"blocks-edit.php?edit=true&amp;position=right&amp;right=".$blocks2["id"]."\"><img border=\"0\" src=\"images/blocks/rightenable.gif\" width=\"18\" height=\"15\" alt=\""._MOVE_RIGHT_."\" /></a>" : "<img border=\"0\" src=\"images/blocks/rightdisable.gif\" width=\"18\" height=\"15\" ".($blocks2["enabled"] ? "alt=\"".T_("_AT_RIGHT_")."\"" : "alt=\""._MUST_ENB_MOVE_."\"")." ".($blocks2["enabled"] ? "onclick=\"javascript: alert('".T_("_AT_RIGHT_")."');\"" : "onclick=\"javascript: alert('"._MUST_ENB_FIRST."');\"")."  />")."</td>".
		...
		"<table class=\"table_table\" cellspacing=\"1\" align=\"center\" width=\"100%\">".
			...
			"<tr>".
				"<td class=\"table_col2\">".
					...
					"</div>".
				"</td>".
				"<td class=\"table_col2\" align=\"center\"><input type=\"text\" name=\"uplsort\" size=\"1\" readonly=\"readonly\" value=\"0\" style=\"text-align: center;\" onclick=\"javascript: alert('".T_("_CLICK_POS_")."');\" /></td>".
				"<td class=\"table_col2\" align=\"center\"><input type=\"checkbox\" name=\"enabledyes\" onclick=\"javascript: uploadonly.disabled = enabledyes.checked; if(enabledyesnotice.style.display == 'block'){enabledyesnotice.style.display = 'none'}else{enabledyesnotice.style.display = 'block'}; if(!checked){uplsort.value = '0'}\"   /></td>".
				"<td class=\"table_col2\" align=\"center\"><input type=\"checkbox\" name=\"uploadonly\" onclick=\"javascript: wantedname.disabled = enabledyes.disabled = description.disabled = pos.disabled = uploadonly.checked; if(uploadonlynotice.style.display == 'block'){uploadonlynotice.style.display = 'none'}else{uploadonlynotice.style.display = 'block'};\"   /></td>".
			"</tr>".
			"<tr>".
				"<td colspan=\"4\" class=\"table_head\" align=\"center\"><input type=\"submit\" class=\"btn\" value=\"".T_("UPLOAD")."\" /><div id=\"uploadonlynotice\" style=\"display: none;\">(".T_("_UPL_ONLY_").")</div><div id=\"enabledyesnotice\" style=\"display: none;\">(".T_("_UPL_ADD_").")</div></td>".
			"</tr>".
		"</table>".
	"</form>");
print("</td></tr></table>");	
