...
<head>
<link type="text/css" rel="stylesheet" href="/min/?b=themes/MS-AZUL&amp;f=theme.css,ddlevelsfiles/ddlevelsmenu-base.css,ddlevelsfiles/ddlevelsmenu-topbar.css,ddlevelsfiles/ddlevelsmenu-sidebar.css" />
<title><?php echo $title; ?></title>
<meta http-equiv="Content-Type" content="text/html; charset=<?php echo $site_config["CHARSET"]; ?>" />
<meta name="author" content="BRShares, BR-Shares" />
<meta name="generator" content="BRShares <?php echo $site_config['ttversion']; ?>" />
<meta name="description" content="BRShares is a feature packed and highly customisable PHP/MySQL Based BitTorrent tracker. Featuring intergrated forums, and plenty of administration options. Please visit www.brshares.com for the support forums. " />
<meta name="keywords" content="http://brshares.com, http://www.brshares.com" />
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $site_config["SITEURL"]; ?>/themes/MS-AZUL/css/dropdown/dropdown.css" />
<script>
...
<!-- CSS -->
<!-- Theme css -->
<link rel="shortcut icon" href="<?php echo $site_config["SITEURL"]; ?>/themes/MS-AZUL/images/favicon.ico" />


 
<!--[if IE]>
    <link rel="stylesheet" type="text/css" href="<?php echo $site_config["SITEURL"]; ?>/themes/MS-AZUL/css/ie.css" />
<![endif]-->
...
<body>
<table width="99%" cellspacing="0" cellpadding="0" border="1" align="center" >
<tr style="height: 99%; background-repeat: repeat-x;">
...
?>
      	    ...
      	    <div ><a href='index.php'><center><img src='themes/MS-AZUL/images/logo.jpg' alt='logo' border='0' width='100%' height='200' /></center></a></div>
...
<tr class="menutopo"  width="99%" cellspacing="2">
	<td class="headmenu">
		  <ul class="dropdown">
		  <li class="">
		  <a href="index.php" class="menuHead">BR</a>
		  <ul class="submenu" >
		  <li class="">
		  ...
		  <li>
		  <a href="http://img.brshares.com/" target="_blank" class="menuHead">Hospedar Imagens</a>
		  </li>
		  <li>
	...
	<td class="headmenu">
		  ...
		  <a href="rules.php" class="menuHead">Regras</a>
		  	  ...
		  	  <li>
		  <a href="falarstaff.php" class="menuHead">Falar Com Equipe BR</a>
		  </li>
		  <li>
		  <a href="staff.php" class="menuHead">Equipe BR</a>
		  </li>
		  </ul>
		  </li>
		  </ul>
...
<td id="left_side">
<div id="left_outer">
<div id="leftcolumn" valign="top"><?php leftblocks();?></div></div></td>
...
<div id="body_outer">
    ...
    <a href="javascript:void(0);" id="mostrar"  >
        <img src="<?php echo $site_config["SITEURL"]; ?>/themes/MS-AZUL/img/clock.png">
        <p>Últimas</p>
    </a>
