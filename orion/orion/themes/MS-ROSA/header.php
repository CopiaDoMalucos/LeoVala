...
<head>
<link type="text/css" rel="stylesheet" href="/min/?b=themes/MS-ROSA&amp;f=theme.css,ddlevelsfiles/ddlevelsmenu-base.css,ddlevelsfiles/ddlevelsmenu-topbar.css,ddlevelsfiles/ddlevelsmenu-sidebar.css" />
...
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $site_config["SITEURL"]; ?>/themes/MS-ROSA/css/dropdown/dropdown.css" />
<script>
...
<!-- CSS -->
<!-- Theme css -->
<link rel="shortcut icon" href="<?php echo $site_config["SITEURL"]; ?>/themes/MS-ROSA/images/favicon.ico" />

<!--[if IE]>
    <link rel="stylesheet" type="text/css" href="<?php echo $site_config["SITEURL"]; ?>/themes/MS-ROSA/css/ie.css" />
<![endif]-->
...
<!--[if lte IE 6]>
    <script type="text/javascript" src="<?php echo $site_config["SITEURL"]; ?>/themes/MS-ROSA/js/pngfix/supersleight-min.js"></script>
<![endif]-->
...
<body>
<table width="99%" cellspacing="1" cellpadding="0" border="1" align="center" >
...
?>
      	    ...
      	    <div ><a href='index.php'><center><img src='themes/MS-ROSA/images/logo.jpg' alt='logo' border='0' width='100%' height='200' /></center></a></div>
