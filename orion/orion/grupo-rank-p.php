...
{ 
        ...
        if ($doapontos == '100' || $doapontos == '200' || $doapontos == '300' || $doapontos == '400' || $doapontos == '500'){
		  ...
		  $select_bonus2=$pdo->prepare("UPDATE users SET seedbonus= seedbonus + :seedbonus where id= :id");
          $select_bonus2->bindParam(':seedbonus', $doapontos);
	      $select_bonus2->bindParam(':id', $row_select['userid']);
          $select_bonus2->execute(); 
