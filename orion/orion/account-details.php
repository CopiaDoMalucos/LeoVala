...
<tr>
<td width="10%" class="tab1_col3" align="right"><font  size="2">BR Pontos:</font></td>
...
{     
        if ($user["freeleechexpire"] == "0000-00-00 00:00:00")
            ...
            echo("Freeleech Expire: Ilimitado Torrents FREE<br>");
...
<tr><td width=50%  align=right  class=tab1_col3><b>Quando:</b></td><td width=50%  align=left class=tab1_col3  ><?php echo $loginstatus; ?></tr>
	<?php if ($user["invited_by"]) {
		...
		<tr><td width=50%  align=right  class=tab1_col3><b>Padrinho:</b></td><td width=50%  align=left class=tab1_col3  >Auto Registro</tr>
        <?php } ?>
...
$sexo="Indefinido";
	...
	if ($user["warned"] == "yes"){
		echo"<center><b><img src=http://www.brshares.com/images/warned.gif>Usuário advertido!<img src=http://www.brshares.com/images/warned.gif></b></center>";
}	

 
	if($user["enabled"] == "no"){
		echo"<center><b><img src=http://www.brshares.com/images/warned.gif>Usuário banido do site!<img src=http://www.brshares.com/images/warned.gif></b></center>";
...
if($CURUSER["edit_users"]=="yes"){
    ...
    print("<tr><td width=50%  align=right  class=tab1_col3>Chat Banido: </td><td width=50%  align=left  class=tab1_col3><input name='hideshoutbox' value='yes' type='radio' />Sim <input name='hideshoutbox' value='no' type='radio' />Não <br>Ao clicar em sim o usuário terá que aguardar 30 minutos para voltar a acessar o Chat<br>Usuário banido $hideshoutbox</td></tr>\n");	
...
//Alterar Nick + fácil
	if($CURUSER["level"]=="Administrador" || $CURUSER["level"]=="S.Moderador" || $CURUSER["level"]=="Sysop" ){
		...
		if(isset($nick) && strlen($nick)>3){
			...
			$body = "Seu nome de usuário no site BRShares foi alterado pelo ".$CURUSER["level"]." ".$CURUSER["username"]."\n\n";
...
begin_framec("Adicionar Upload");
	if (isset($_REQUEST['adicionarUp'])){
		...
		write_logstaff("Usuário","#FF0000","O usuário [url=http://www.brshares.com/account-details.php?id=".$CURUSER['id']."]".$CURUSER['username']."[/url] adicionou ".$qtde." bytes de upload para o usuário [url=http://www.brshares.com/account-details.php?id=".$user["id"]."]".$user["username"]."[/url]\n");
