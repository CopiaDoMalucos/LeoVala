...
// Main Site Settings
$site_config['SITENAME'] = '..::BRShares::.. Sempre fazendo o melhor por você!!!';					//Site Name
$site_config['SITEEMAIL'] = 'contato@brshares.com';		//Emails will be sent from this address
$site_config['SITEURL'] = 'http://www.brshares.com';	//Main Site URL
...
$site_config['announce_list'] = "http://www.brshares.com/announce.php"; //seperate via comma
...
$site_config['OFFLINEMSG'] = 'O site BRShares em manutenção. Por favor, aguarde. já voltamos';	

$site_config['WELCOMEPMON'] = true;			//Auto PM New members
$site_config['WELCOMEPMMSG'] = 'Seja Bem Vindo ao BRShares! Antes de navegar pelo site, leia as [url=http://www.brshares.com/rules.php]Regras [/url] e a [url=http://www.brshares.com/faq.php]Ajuda[/url], Lembre-se de manter o seu rátio igual ou superior a 1,00, para mais informações procure a [url=http://www.brshares.com/staff.php]Equipe[/url] do site.
...
Os torrents lançados deverão ser semeados por um período mínimo de 78 horas.
...
$site_config['PEERLIMIT'] = '100000000000';			//LIMIT NUMBER OF PEERS GIVEN IN EACH ANNOUNCE
$site_config['autoclean_interval'] = '1800';		//Time between each auto cleanup (Seconds)
...
$site_config["ratiowarn_minratio"] = 1.0; //Min Ratio
...
$site_config["mail_smtp_host"] = "meg.securedserverspace.com"; // SMTP server hostname
...
$site_config["mail_smtp_user"] = "contato@brshares.com"; // SMTP username
$site_config["mail_smtp_pass"] = "}~3NkHi9yp;T"; // SMTP password
