...
echo '<ul style="margin:0;padding:0;" class="alista">';
	...
	foreach ($cols as $col) {
		switch ($col) {
                        ...
                        break;
                        case 'seeders':
                                echo "<div style='width: 60px;' class='divhead'><div style='width: 60px; font-size: 10px;'><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_cat."&freeleech=".$freeleech."&sort=seeders&order=".($sort=="seeders" && $order=="desc"?"asc":"desc")."\"><font color='white'><img src='http://s33.postimg.org/mahmqu7rj/setacima.png' border='0' alt='Leechers' /></font></a>".($sort=="seeders"?$fleche:"")."</div></div>";
                        break;
                        case 'leechers':
                                echo "<div style='width: 60px;' class='divhead'><div style='width: 60px; font-size: 10px;'><a href=\"$scriptname?$addparam"."cat=".$idteam."&parent_cat=".$parent_cat."&freeleech=".$freeleech."&sort=leechers&order=".($sort=="leechers" && $order=="desc"?"asc":"desc")."\"><font color='white'><img src='http://s33.postimg.org/gxsscpjv3/setabaixo.png' border='0' alt='Seeders' /></font></a>".($sort=="leechers"?$fleche:"")."</div></div>";
                        break;
