...
function simple_php_captcha($config = array()) {
    ...
    $captcha_config = array(
        ...
        'characters' => 'ABCDEFGHJKLMNPRSTUVWXYZ123456789',
        'min_font_size' => 28,
        'max_font_size' => 28,
        'color' => '#666',
        'angle_min' => 0,
    ...
    $image_src = substr(__DIR__, strlen( dirname(__DIR__) ) ). DIRECTORY_SEPARATOR . 'simple-php-captcha.php?_CAPTCHA&amp;t=' . urlencode(microtime());
