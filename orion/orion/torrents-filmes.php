...
// screenshots //
print ("<TR><TD width=50%  align=right  class=tab1_col3>Capa: *</td><td title ='- Informe a URL da capa do filme, de preferência com boa resolução.&lt;br&gt;&lt;br&gt;Recomenda-se que as imagens sejam hospedadas no &lt;FONT COLOR=red&gt;&lt;B&gt;&lt;br&gt;tinypic.com&lt;FONT COLOR=red&gt;&lt;B&gt;&lt;br&gt;imgur.com&lt;/B&gt;&lt;/FONT&gt;' width=50%  align=left class=tab1_col3 ><input  type=text name=screens1  id=screens1  size=30 value=" . $_POST['screens1'] . " ><a href=\"javascript: void(0);\" onclick=\"window.open('http://img.brshares.com/', 'Upload','width=610,height=600,resizable=no,scrollbars=yes,toolbar=no,location=no,directories=no,status=no');\">Hospedar imagem</a><BR>\n</td></tr>");
print ("<TR><TD width=50%  align=right  class=tab1_col3>Screen 1: *</td><td  title ='- Informe a URL de uma screen real do filme. Não serão aceitas screens falsas.<br><br>- Recomenda-se que as imagens sejam hospedadas no <br><FONT COLOR=red><B>tinypic.com</B></FONT><br><FONT COLOR=red><B>imgur.com</B></FONT>' width=50%  align=left class=tab1_col3><input type=text name=screens2  id=screens2 size=30 value=" . $_POST['screens2'] . "><BR>\n</td></tr>");
print ("<TR><TD width=50%  align=right  class=tab1_col3>Screen 2: *</td><td  width=50%  align=left class=tab1_col3><input type=text name=screens3 id=screens3 size=30 value=" . $_POST['screens3'] . "><a href='http://imgur.com/'>imgur</a> ou <a href='https://www.flickr.com/'>flickr</a><BR>\n</td></tr>");
