...
$arr56 = mysql_fetch_assoc($res65);	
      ...
      {
     showerror("Fórum erro","O Assunto deve ter no mínimo 10 caracteres.");
        }
...
$datetime = get_date_time(gmtime() - 180);
				...
				$donated = $arr2['freeleechuser'];
				$by = "<a href='account-details.php?id=$posterid'><b>$postername</b></a>" . ($donated == 'yes' ? "<img src='".$site_config['SITEURL']."/images/star.gif' alt='Donated'>" : "") . "";
			}
...
//Post Bottom
	...
	print("<tr  class='p-title-barra '><td width='150' align='center'><nobr> <a href='account-details.php?id=$posterid'><img src=".$themedir."icon_profile.gif ></a> <a href='enviarmp.php?receiver=$postername'><img src='".$themedir."icon_pm.gif' ></a> </nobr><td with='100%'>");
