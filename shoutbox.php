...
if (isset($_GET['del'])){
	...
	if ($CURUSER && $CURUSER["class"] >= 74) {
	    write_logstaff("Shoutbox","#FF0000","A mensagen do [url=http://www.brshares.com/account-details.php?id=".$row123456['userid']."]".$row123456['user']."[/url] foi apagada por [url=http://www.brshares.com/account-details.php?id=".$CURUSER['id']."]".$CURUSER['username']."[/url] \n");
...
if (isset($_GET['history'])) {
	...
	$query = 'SELECT shoutbox.message, shoutbox.userid, shoutbox.date, shoutbox.user, shoutbox.msgid, users.class, users.freeleechuser, users.dj  FROM shoutbox  LEFT JOIN users ON shoutbox.userid = users.id ORDER BY msgid DESC LIMIT '.$lowerlimit.','.$upperlimit;
}else{
	$query = 'SELECT shoutbox.message, shoutbox.userid, shoutbox.date, shoutbox.user, shoutbox.msgid, users.class, users.freeleechuser, users.dj  FROM shoutbox  LEFT JOIN users ON shoutbox.userid = users.id ORDER BY msgid DESC LIMIT 25';
}
...
$teste12 = "$string11[0]";
	...
	echo "</div>";
		...
		if ($CURUSER && $CURUSER["class"] >= 75) {
			    	...
			    	if ($row["userid"] !== $CURUSER["id"] && $row["userid"] !== '0' ) {
...
$user =  "<font color=#FF0000><B>$user</B></font>";
}
	if ($row["freeleechuser"] == 'yes'){
					$user =  "$user <img src=/images/star.gif width=13 height=13 >";
					}

 $numtorrents = get_row_count("torrents", "WHERE owner = ".$row["userid"]."");

if ($numtorrents >= 4000){
			$user =  "$user <img src=/images/exercito/17-Marechal.png width=13 height=13 title='Parabéns! >Marechal< Você tem +4000 torrents lançados '>";
	
}
elseif ($numtorrents >= 3000){
			$user =  "$user <img src=/images/exercito/16-General-do-Exercito.png width=13 height=13 title='Parabéns! >General< Você tem +3000 torrents lançados '>";
	
}	
elseif ($numtorrents >= 2800){
			$user =  "$user <img src=/images/exercito/15-General-de-Divisao.png width=13 height=13 title='Parabéns! >Genera de Divisão< Você tem +2800 torrents lançados '>";
	
}	
elseif ($numtorrents >= 2600){
			$user =  "$user <img src=/images/exercito/14-General-de-Brigada.png width=13 height=13 title='Parabéns! >General de Brigada< Você tem +2600 torrents lançados '>";
	
}
elseif ($numtorrents >= 2400){
			$user =  "$user <img src=/images/exercito/13-Coronel.png width=13 height=13 title='Parabéns! >Coronel< Você tem +2400 torrents lançados '>";
	
}
elseif ($numtorrents >= 2200){
			$user =  "$user <img src=/images/exercito/12-Tenente-Coronel.png width=13 height=13 title='Parabéns! >Tenete Coronel< Você tem +2200 torrents lançados '>";
	
}
elseif ($numtorrents >= 2000){
			$user =  "$user <img src=/images/exercito/11-Major.png width=13 height=13 title='Parabéns! >Major< Você tem +2000 torrents lançados '>";
	
}
elseif ($numtorrents >= 1800){
			$user =  "$user <img src=/images/exercito/10-Capitao.png width=13 height=13 title='Parabéns! >Capitão< Você tem +1800 torrents lançados '>";
	
}
elseif ($numtorrents >= 1600){
			$user =  "$user <img src=/images/exercito/09-Primeiro-Tenente.png width=13 height=13 title='Parabéns! >Primeiro Tenente< Você tem +1600 torrents lançados '>";
	
}
elseif ($numtorrents >= 1400){
			$user =  "$user <img src=/images/exercito/08-Segundo-Tenente.png width=13 height=13 title='Parabéns! >Sengundo Tenente< Você tem +1400 torrents lançados '>";
	
}
elseif ($numtorrents >= 1200){
			$user =  "$user <img src=/images/exercito/07-Aspirante.png width=13 height=13 title='Parabéns! >Aspirante< Você tem +1200 torrents lançados '>";
	
}
elseif ($numtorrents >= 1100){
			$user =  "$user <img src=/images/exercito/06-Subtenente.png width=13 height=13 title='Parabéns! >Subtenente< Você tem +1100 torrents lançados '>";
	
}
elseif ($numtorrents >= 900){
			$user =  "$user <img src=/images/exercito/05-Primeiro-Sargento.png width=13 height=13 title='Parabéns! >Primeiro Sargento< Você tem +900 torrents lançados '>";
	
}
elseif ($numtorrents >= 800){
			$user =  "$user <img src=/images/exercito/04-Segundo-Sargento.png width=13 height=13 title='Parabéns! >Sengundo Sargento< Você tem +800 torrents lançados '>";
	
}
elseif ($numtorrents >= 600){
			$user =  "$user <img src=/images/exercito/03-Terceiro-Sargento.png width=13 height=13 title='Parabéns! >Terceiro Sargento< Você tem +600 torrents lançados '>";
	
}
elseif ($numtorrents >= 400){
			$user =  "$user <img src=/images/exercito/02-Cabo.png width=13 height=13 title='Parabéns! >Cabo< Você tem +400 torrents lançados '>";
	
}		
elseif ($numtorrents >= 200){
			$user =  "$user <img src=/images/exercito/01-Soldado.png width=13 height=13 title='Parabéns! >Soldado< Você tem +200 torrents lançados '>";
	
}	

 $numtorrentsseed = get_row_count("torrents","WHERE  seeders > '0' AND owner = ".$row["userid"]."");

if ($numtorrentsseed >= 1000){
			$user =  "$user <img src=/images/ForcaAerea/17-Marechal.png width=13 height=13 title='Parabéns! >Marechal< Você tem +1000 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 480){
			$user =  "$user <img src=/images/ForcaAerea/16-Tenente_Brigadeiro.png width=13 height=13 title='Parabéns! >Tenete Brigadeiro< Você tem +480 torrents lançados com no minimo 1 Seed'>";
	
}	
elseif ($numtorrentsseed >= 450){
			$user =  "$user <img src=/images/ForcaAerea/15-Major_Brigadeiro.png width=13 height=13 title='Parabéns! >Major Brigadeiro< Você tem +450 torrents lançados com no minimo 1 Seed'>";
	
}	
elseif ($numtorrentsseed >= 420){
			$user =  "$user <img src=/images/ForcaAerea/14-Brigadeiro.png width=13 height=13 title='Parabéns! >General de Brigada< Você tem +420 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 390){
			$user =  "$user <img src=/images/ForcaAerea/13-Coronel.png width=13 height=13 title='Parabéns! >Coronel< Você tem +390 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 360){
			$user =  "$user <img src=/images/ForcaAerea/12-Tenente-Coronel.png width=13 height=13 title='Parabéns! >Tenete Coronel< Você tem +360 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 330){
			$user =  "$user <img src=/images/ForcaAerea/11-Major.png width=13 height=13 title='Parabéns! >Major< Você tem +330 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 300){
			$user =  "$user <img src=/images/ForcaAerea/10-Capitao.png width=13 height=13 title='Parabéns! >Capitão< Você tem +300 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 270){
			$user =  "$user <img src=/images/ForcaAerea/09-Primeiro-Tenente.png width=13 height=13 title='Parabéns! >Primeiro Tenente< Você tem +270 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 240){
			$user =  "$user <img src=/images/ForcaAerea/08-Segundo-Tenente.png width=13 height=13 title='Parabéns! >Sengundo Tenente< Você tem +240 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 210){
			$user =  "$user <img src=/images/ForcaAerea/07-Aspirante.png width=13 height=13 title='Parabéns! >Aspirante< Você tem +210 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 180){
			$user =  "$user <img src=/images/ForcaAerea/06-Suboficial.png width=13 height=13 title='Parabéns! >Suboficial< Você tem +180 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 150){
			$user =  "$user <img src=/images/ForcaAerea/05-Primeiro-Sargento.png width=13 height=13 title='Parabéns! >Primeiro Sargento< Você tem +150 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 120){
			$user =  "$user <img src=/images/ForcaAerea/04-Segundo-Sargento.png width=13 height=13 title='Parabéns! >Sengundo Sargento< Você tem +120 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 90){
			$user =  "$user <img src=/images/ForcaAerea/03-Terceiro-Sargento.png width=13 height=13 title='Parabéns! >Terceiro Sargento< Você tem +90 torrents lançados com no minimo 1 Seed'>";
	
}
elseif ($numtorrentsseed >= 60){
			$user =  "$user <img src=/images/ForcaAerea/02-Cabo.png width=13 height=13 title='Parabéns! >Cabo< Você tem +60 torrents lançados com no minimo 1 Seed'>";
	
}		
elseif ($numtorrentsseed >= 30){
			$user =  "$user <img src=/images/ForcaAerea/01-Soldado.png width=13 height=13 title='Parabéns! >Soldado< Você tem +30 torrents lançados com no minimo 1 Seed'>";
...
echo '</td><td style="font-size: 12px; padding-left: 5px"><a href="'.$site_config['SITEURL'].'/account-details.php?id='.$row['userid'].'" target="_parent"><b>' .$user. '</b></a>:&nbsp;&nbsp;'.$verdade;
  	...
  	if ($user == 'Anúncio!'){
echo '</td><td style="font-size: 12px; padding-left: 5px"><b>' .$user. '</b>:&nbsp;&nbsp;'.nl2br(format_comment($row['message']));
}else{
...
window.location="http://www.brshares.com/shoutbox.php";
return
}
