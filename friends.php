...
SQL_Query_exec("INSERT INTO messages (poster, sender, receiver, added, subject, msg) VALUES ('0', '0', $fid, NOW(),'Convite', " . sqlesc($friendmsg) . ")");
 ...
 print("<center>Uma mensagem foi enviada para: <b><a href='account-details.php?id=".$fid."'>".$fusername."</a></b> para que o mesmo aceite o seu covite de amizade .<BR></center>");
