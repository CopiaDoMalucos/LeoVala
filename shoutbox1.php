...
if ($numtorrentsseed >= 400){
			$user =  "$user <img src=/images/ForcaAerea/17-Marechal.png width=13 height=13 title='Parabéns! >Marechal< Você tem +4000 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 340){
			$user =  "$user <img src=/images/ForcaAerea/16-Tenente_Brigadeiro.png width=13 height=13 title='Parabéns! >General< Você tem +3000 torrents lançados '>";
	
}	
elseif ($numtorrentsseed >= 310){
			$user =  "$user <img src=/images/ForcaAerea/15-Major_Brigadeiro.png width=13 height=13 title='Parabéns! >Genera de Divisão< Você tem +2800 torrents lançados '>";
	
}	
elseif ($numtorrentsseed >= 290){
			$user =  "$user <img src=/images/ForcaAerea/14-Brigadeiro.png width=13 height=13 title='Parabéns! >General de Brigada< Você tem +2600 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 270){
			$user =  "$user <img src=/images/ForcaAerea/13-Coronel.png width=13 height=13 title='Parabéns! >Coronel< Você tem +2400 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 250){
			$user =  "$user <img src=/images/ForcaAerea/12-Tenente-Coronel.png width=13 height=13 title='Parabéns! >Tenete Coronel< Você tem +2200 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 230){
			$user =  "$user <img src=/images/ForcaAerea/11-Major.png width=13 height=13 title='Parabéns! >Major< Você tem +2000 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 210){
			$user =  "$user <img src=/images/ForcaAerea/10-Capitao.png width=13 height=13 title='Parabéns! >Capitão< Você tem +1800 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 190){
			$user =  "$user <img src=/images/ForcaAerea/09-Primeiro-Tenente.png width=13 height=13 title='Parabéns! >Primeiro Tenente< Você tem +1600 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 170){
			$user =  "$user <img src=/images/ForcaAerea/08-Segundo-Tenente.png width=13 height=13 title='Parabéns! >Sengundo Tenente< Você tem +1400 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 150){
			$user =  "$user <img src=/images/ForcaAerea/07-Aspirante.png width=13 height=13 title='Parabéns! >Aspirante< Você tem +1200 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 130){
			$user =  "$user <img src=/images/ForcaAerea/06-Suboficial.png width=13 height=13 title='Parabéns! >Subtenente< Você tem +1100 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 110){
			$user =  "$user <img src=/images/ForcaAerea/05-Primeiro-Sargento.png width=13 height=13 title='Parabéns! >Primeiro Sargento< Você tem +900 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 90){
			$user =  "$user <img src=/images/ForcaAerea/04-Segundo-Sargento.png width=13 height=13 title='Parabéns! >Sengundo Sargento< Você tem +800 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 70){
			$user =  "$user <img src=/images/ForcaAerea/03-Terceiro-Sargento.png width=13 height=13 title='Parabéns! >Terceiro Sargento< Você tem +600 torrents lançados '>";
	
}
elseif ($numtorrentsseed >= 40){
			$user =  "$user <img src=/images/ForcaAerea/02-Cabo.png width=13 height=13 title='Parabéns! >Cabo< Você tem +400 torrents lançados '>";
	
}		
elseif ($numtorrentsseed >= 20){
			$user =  "$user <img src=/images/ForcaAerea/01-Soldado.png width=13 height=13 title='Parabéns! >Soldado< Você tem +200 torrents lançados '>";
