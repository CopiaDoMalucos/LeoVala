...
<td width="20%" align="center" style="padding-right: 3px; padding-right: 3px;"><a href="top10.php?acao=4"><img border="0" alt=""  width="83" height="80" src="images/top/star.png"><br>Hall da Fama</a></td>
</tr></tbody></table>
  <?php 
...
<td align="center" class="ttable_col6"><a href="account-details.php?id=<?php echo $rowtemps["id"]?>"><?php echo $rowtemps["username"]?></a></td>
...
<td align="center" class="ttable_col6"><b><?php echo mksize($rowupestado["ul"]); ?></b></td></tr>
 ...
 <?php endif; ?>
  ...
  ?>
<div align="justify" class="blockContent"><table cellspacing="1" cellpadding="0" align="center" id="tabela1"><tbody><tr><td align="center" colspan="3" class="tab1_cab1">Hall da Fama</td></tr><tr>
<td width="10%" align="center" class="ttable_head"><b>Posição</b></td>
<td align="left" class="ttable_head"><b>Usuários</b></td>
<td width="70" align="center" class="ttable_head"><b>Lançamentos</b></td>
</tr>
     <?php
 $res = mysql_query("SELECT u.id, u.username, t.uid, COUNT(t.uid) as num FROM torrentlancado t LEFT JOIN users u ON u.id = t.uid WHERE u.enabled = 'yes' AND t.aprovado = '1'  GROUP BY uid ORDER BY num DESC LIMIT 10");
  
	?>
<tr>
    <?php $i = 1; while ($row = mysql_fetch_assoc($res)): ?>
<td align="center" class="ttable_col6"><b><?php echo ($i); ?></b></td>
<td align="left" class="ttable_col6"><a href="account-details.php?id=<?php echo $row["id"]?>"><?php echo $row["username"]?></a></td>
<td align="center" class="ttable_col6"><b><?php echo $row["num"]; ?></b></td>
