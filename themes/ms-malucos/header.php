...
<!-- PNG FIX -->
<!--[if lte IE 6]>
<script type='text/javascript' src='<?php echo $site_config["SITEURL"]; ?>/themes/ms-malucos/js/pngfix/supersleight-min.js'></script>
<![endif]-->

 <link rel="stylesheet" type="text/css" href="<?php echo $site_config["SITEURL"]; ?>/themes/ms-malucos/css/green.css" />
<!-- *JS* -->
...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.js'></script>
 <!-- inicio baloo -->
<script type="text/javascript" src="<?= $site_config["SITEURL"]; ?>/themes/ms-malucos/overlib.js"></script>
<!-- fim baloo -->
...
<div id='wrapper'>
	   <iframe 
src="http://www.streamjei.com.br/aacplus/dumorim/playertopo1.swf" 
marginwidth="0" marginheight="0" width="980" frameborder="0" 
height="30" scrolling="No"></iframe>
 ...
 print("S. Bônus " .  $CURUSER[seedbonus] . "&nbsp;&nbsp;");



	echo " <a class='profile' href='account.php'><img src='themes/MS-PRETO/images/blank.gif' border='none' height='16' width='16' alt='Sua conta' title='Sua conta'></a> <a class='account' href='account-details.php?id=$CURUSER[id]'><img src='themes/MS-PRETO/images/blank.gif' border='none' height='16' width='16' alt='Perfil' title='Perfil'></a> <a class='logout' href=\"account-logout.php\"><img src='themes/MS-PRETO/images/blank.gif' border='none' height='16' width='16' alt='Sair' title='Sair'></a> ";

	if ($CURUSER["control_panel"]=="yes") {

		print("<a class='admincp' href=admincp.php><img src='themes/MS-PRETO/images/blank.gif' border='none' height='16' width='16' alt='Admincp' title='Admin CP'></a> ");
	...
	if ($unreadmail){
		...
		print("<a class='mail_n' href=mailbox.php?Entrada><img src='themes/MS-PRETO/images/blank.gif' border='none' height='16' width='16' alt='Nova mensagem' title='($unreadmail) Nova mensagem'S'></a></a>&nbsp;");

	}else{

		print("<a class='mail' href=mailbox.php><img src='themes/MS-PRETO/images/blank.gif' border='none' height='16' width='16' alt='Minhas mensagens' title='Minhas mensagens'></a>&nbsp;");
...
<ul>
   ...
   <li class='has-sub '><a href='forums.php'><span>Forum</span></a>
      <ul>
         <li class='has-sub '><a href='forums.php?action=Forum' ><span>Pesquisa</span></a>
         </li>
        
      </ul>
   </li>
   <li><a href='rules.php' ><span>Regras</span></a></li>
    <li class='has-sub '><a href='forums.php'><span>Torrents</span></a>
      <ul>
		    ...
		    <li class='has-sub '><a href='torrents-today.php' ><span>Torrent do dia</span></a>
			   <li class='has-sub '><a href='torrents.php' ><span>Ver todos</span></a>
			      <li class='has-sub '><a href='torrents-needseed.php' ><span>Sem seed</span></a>
				     <li class='has-sub '><a href='reqall.php?Section=Request'><span>Pedir torrent</span></a>
					    <li class='has-sub '><a href='reqall.php' ><span>Ver pedidos</span></a>
  ...
  <li><a href='topten.php' ><span>Top</span></a></li>
