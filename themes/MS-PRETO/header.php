...
<head>
<link type="text/css" rel="stylesheet" href="/min/?f=ddlevelsfiles/ddlevelsmenu-basep.css,ddlevelsfiles/ddlevelsmenu-topbarp.css,ddlevelsfiles/ddlevelsmenu-sidebarp.css,themes/MS-PRETO/theme.css" />
...
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $site_config["SITEURL"]; ?>/themes/MS-PRETO/css/dropdown/dropdown.css" />
<script>
...
<!-- CSS -->
<!-- Theme css -->
<link rel="shortcut icon" href="<?php echo $site_config["SITEURL"]; ?>/themes/MS-PRETO/images/favicon.ico" />

<!--[if IE]>
    <link rel="stylesheet" type="text/css" href="<?php echo $site_config["SITEURL"]; ?>/themes/MS-PRETO/css/ie.css" />
<![endif]-->
...
<!--[if lte IE 6]>
    <script type="text/javascript" src="<?php echo $site_config["SITEURL"]; ?>/themes/MS-PRETO/js/pngfix/supersleight-min.js"></script>
<![endif]-->
...
<body>
<table width="99%" cellspacing="2" cellpadding="0" border="0" align="center" >
...
?>
      	    ...
      	    <div class='logo'><a href='index.php'><center><img src='themes/MS-PRETO/images/logo.jpg' alt='logo' border='0' width='100%' height='200' /></center></a></div>
...
<table width="99%" cellspacing="0" cellpadding="0" border="0" align="center" id="nav" style="z-index: 999;" >
    ...
    <td class="separator"></td>
		...
		<td class="headmenu">
		  <ul class="dropdown">
		  <li class="">
		  <a href="entrada.php" class="menuHead">Mensagens <?php echo $novamp ;?></a>
		  <ul class="submenu" >
		  <li>
